...
function expectLaunchctlEnableBootstrapOrder(env: Record<string, string | undefined>) {
  ...
  const label = "ai.crawclaw.gateway";
...
describe("launchctl list detection", () => {
  it("detects the resolved label in launchctl list", async () => {
    state.listOutput = "123 0 ai.crawclaw.gateway\n";
    const listed = await isLaunchAgentListed({
      env: { HOME: "/Users/test", CRAWCLAW_PROFILE: "default" },
    });
...
describe("launchd install", () => {
  ...
  it("shows actionable guidance when launchctl gui domain does not support bootstrap", async () => {
    ...
    expect(message).toContain("https://docs.crawclaw.ai/gateway");
  });
...
describe("resolveLaunchAgentPlistPath", () => {
  it.each([
    {
      name: "uses default label when CRAWCLAW_PROFILE is unset",
      env: { HOME: "/Users/test" },
      expected: "/Users/test/Library/LaunchAgents/ai.crawclaw.gateway.plist",
    },
    {
      name: "uses profile-specific label when CRAWCLAW_PROFILE is set to a custom value",
      env: { HOME: "/Users/test", CRAWCLAW_PROFILE: "jbphoenix" },
      expected: "/Users/test/Library/LaunchAgents/ai.crawclaw.jbphoenix.plist",
    },
    {
      name: "prefers CRAWCLAW_LAUNCHD_LABEL over CRAWCLAW_PROFILE",
      env: {
        HOME: "/Users/test",
        CRAWCLAW_PROFILE: "jbphoenix",
        CRAWCLAW_LAUNCHD_LABEL: "com.custom.label",
      },
      expected: "/Users/test/Library/LaunchAgents/com.custom.label.plist",
    },
    {
      name: "trims whitespace from CRAWCLAW_LAUNCHD_LABEL",
      env: {
        HOME: "/Users/test",
        CRAWCLAW_LAUNCHD_LABEL: "  com.custom.label  ",
      },
    ...
    {
      name: "ignores empty CRAWCLAW_LAUNCHD_LABEL and falls back to profile",
      env: {
        HOME: "/Users/test",
        CRAWCLAW_PROFILE: "myprofile",
        CRAWCLAW_LAUNCHD_LABEL: "   ",
      },
      expected: "/Users/test/Library/LaunchAgents/ai.crawclaw.myprofile.plist",
    },
  ])("$name", ({ env, expected }) => {
