...
import { buildPluginConfigSchema, type CrawClawPluginConfigSchema } from "crawclaw/plugin-sdk/core";
...
export function createOpenShellPluginConfigSchema(): CrawClawPluginConfigSchema {
