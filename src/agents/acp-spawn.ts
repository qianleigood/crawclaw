...
export async function spawnAcpDirect(
  ...
  let initializedRuntimeCloseHandle: AcpSpawnRuntimeCloseHandle | undefined;
  try {
    await callGateway({
    ...
    initializedRuntimeCloseHandle = initializedSession.runtimeCloseHandle;
    ...
    await cleanupFailedAcpSpawn({
      ...
      runtimeCloseHandle: initializedRuntimeCloseHandle,
    });
    return {
      status: "error",
