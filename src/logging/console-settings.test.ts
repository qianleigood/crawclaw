...
let originalCrawClawTestConsole: string | undefined;
...
beforeEach(() => {
  ...
  originalCrawClawTestConsole = process.env.CRAWCLAW_TEST_CONSOLE;
...
afterEach(() => {
  ...
  if (originalCrawClawTestConsole === undefined) {
    delete process.env.CRAWCLAW_TEST_CONSOLE;
  } else {
    process.env.CRAWCLAW_TEST_CONSOLE = originalCrawClawTestConsole;
  }
