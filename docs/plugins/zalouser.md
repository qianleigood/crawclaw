...
read_when:
  - You want Zalo Personal (unofficial) support in CrawClaw
...
Zalo Personal support for CrawClaw via a plugin, using native `zca-js` to automate a normal Zalo user account.
