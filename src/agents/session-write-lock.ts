...
const CLEANUP_STATE_KEY = Symbol.for("crawclaw.sessionWriteLockCleanupState");
const HELD_LOCKS_KEY = Symbol.for("crawclaw.sessionWriteLockHeldLocks");
const WATCHDOG_STATE_KEY = Symbol.for("crawclaw.sessionWriteLockWatchdogState");
