 ...
 * Keys are channel IDs (e.g., "feishu", "weixin") or "*" for global default.
...
export type CommandsConfig = {
  ...
  config?: boolean;
  /** Allow /mcp command for CrawClaw-managed MCP settings (default: false). */
  mcp?: boolean;
