...
vi.mock("crawclaw/plugin-sdk/provider-auth", async () => {
  const actual = await vi.importActual<typeof import("crawclaw/plugin-sdk/provider-auth")>(
    "crawclaw/plugin-sdk/provider-auth",
  );
  return {
    ...actual,
