import type { GatewayAuthConfig, CrawClawConfig } from "../config/config.js";
import { resolveSecretInputRef } from "../config/types.secrets.js";
import { resolveRequiredConfiguredSecretRefInputString } from "./resolve-configured-secret-input-string.js";

export function withGatewayAuthPassword(cfg: CrawClawConfig, password: string): CrawClawConfig {
  return {
    ...cfg,
    gateway: {
      ...cfg.gateway,
