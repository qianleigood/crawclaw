...
export function listAuthProfileStorePaths(config: CrawClawConfig, stateDir: string): string[] {
...
export function collectAuthStorePaths(config: CrawClawConfig, stateDir: string): string[] {
