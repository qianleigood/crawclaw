import type { ChannelSetupInput } from "crawclaw/plugin-sdk/channel-setup";
...
import { hasConfiguredSecretInput } from "crawclaw/plugin-sdk/secret-input";
import {
...
export const nextcloudTalkSetupWizard: ChannelSetupWizard = {
  ...
  introNote: {
    ...
    lines: [
      ...
      '2) Run: ./occ talk:bot:install "CrawClaw" "<shared-secret>" "<webhook-url>" --feature reaction',
