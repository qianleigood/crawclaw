...
describe("gateway-cli coverage", () => {
  ...
  it("registers gateway discover and prints json output", async () => {
    ...
    discoverGatewayBeacons.mockResolvedValueOnce([
      {
        instanceName: "Studio (CrawClaw)",
        displayName: "Studio",
        domain: "crawclaw.internal.",
        host: "studio.crawclaw.internal",
        port: 18789,
    ...
    await withEnvOverride(
      {
        ...
        CRAWCLAW_LAUNCHD_LABEL: undefined,
        CRAWCLAW_SYSTEMD_UNIT: undefined,
        INVOCATION_ID: undefined,
        SYSTEMD_EXEC_PID: undefined,
        JOURNAL_STREAM: undefined,
        CRAWCLAW_WINDOWS_TASK_NAME: undefined,
        CRAWCLAW_SERVICE_MARKER: undefined,
        CRAWCLAW_SERVICE_KIND: undefined,
      },
      async () => {
