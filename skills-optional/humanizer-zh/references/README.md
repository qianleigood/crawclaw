...
2. 将 `humanizer-zh` 文件夹复制到你的 skills 目录
3. 确保目录结构如下：
   ```
   skills/humanizer-zh/
   ├── SKILL.md
...
重新加载技能后，直接用自然语言触发即可，例如：

```text
请帮我把下面这段文字改得更自然一点，去掉明显的 AI 写作痕迹。
```
...
在 CrawClaw 或其他兼容 skills 的代理里，你可以通过以下方式使用 Humanizer：
...
```text
请用 humanizer 帮我改写这段话，让它更自然，保留专业语气，不要太像营销文案：
...
1. 过度强调意义、遗产和更广泛的趋势
2. 过度强调知名度和媒体报道
3. 句尾补充式的虚假深化分析（英文原始规则来自 `-ing` 结构）
4. 宣传和广告式语言
5. 模糊归因和含糊措辞
6. 提纲式的"挑战与未来展望"部分
...
14. 粗体过度使用
15. 内联标题垂直列表
16. 标题格式过度规整（英文里常表现为标题大写；中文里更多表现为模板化标题）
17. 表情符号
18. 引号风格不自然
