...
export function applyMessageDefaults(cfg: CrawClawConfig): CrawClawConfig {
...
export function applyModelDefaults(cfg: CrawClawConfig): CrawClawConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: CrawClawConfig): CrawClawConfig {
...
export function applyLoggingDefaults(cfg: CrawClawConfig): CrawClawConfig {
...
export function applyContextPruningDefaults(cfg: CrawClawConfig): CrawClawConfig {
...
export function applyCompactionDefaults(cfg: CrawClawConfig): CrawClawConfig {
  const defaults = cfg.agents?.defaults;
  if (!defaults) {
    return cfg;
  }
