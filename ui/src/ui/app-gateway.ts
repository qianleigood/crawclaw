...
export function connectGateway(host: GatewayHost, options?: ConnectGatewayOptions) {
  ...
  const client = new GatewayBrowserClient({
    ...
    onHello: (hello) => {
      ...
      resetActionFeed(host as unknown as Parameters<typeof resetActionFeed>[0]);
      ...
      void subscribeSessions(host as unknown as CrawClawApp);
      void loadAssistantIdentity(host as unknown as CrawClawApp);
      void loadAgents(host as unknown as CrawClawApp);
      void loadHealthState(host as unknown as CrawClawApp);
      void loadNodes(host as unknown as CrawClawApp, { quiet: true });
      void loadDevices(host as unknown as CrawClawApp, { quiet: true });
...
function handleTerminalChatEvent(
  ...
  if (runId && host.refreshSessionsAfterChat.has(runId)) {
    ...
    if (state === "final") {
      void loadSessions(host as unknown as CrawClawApp, {
  ...
  if (hadToolEvents && state === "final") {
    void loadChatHistory(host as unknown as CrawClawApp);
    return true;
  }
  return false;
}
...
function handleChatGatewayEvent(host: GatewayHost, payload: ChatEventPayload | undefined) {
  ...
  const state = handleChatEvent(host as unknown as CrawClawApp, payload);
...
function handleGatewayEventUnsafe(host: GatewayHost, evt: GatewayEventFrame) {
  ...
  if (evt.event === "agent") {
    ...
    handleAgentActionEvent(
      host as unknown as Parameters<typeof handleAgentActionEvent>[0],
