...
type AgentDefaultsModels = NonNullable<NonNullable<CrawClawConfig["agents"]>["defaults"]>["models"];
...
export function buildAnthropicCliMigrationResult(config: CrawClawConfig): ProviderAuthResult {
