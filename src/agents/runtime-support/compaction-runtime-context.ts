 ...
 */
export function resolveAgentCompactionTarget(params: {
  config?: CrawClawConfig;
...
export function buildAgentCompactionRuntimeContext(params: {
...
}): AgentCompactionRuntimeContext {
  const resolved = resolveAgentCompactionTarget({
