...
vi.mock("crawclaw/plugin-sdk/config-runtime", async () => {
  ...
  return {
    ...actual,
    loadConfig: () => config,
    resolveStorePath: vi.fn(() => "/tmp/crawclaw-sessions.json"),
...
vi.mock("crawclaw/plugin-sdk/conversation-runtime", async () => {
  const actual = await vi.importActual<typeof import("crawclaw/plugin-sdk/conversation-runtime")>(
    "crawclaw/plugin-sdk/conversation-runtime",
  );
  return {
    ...actual,
...
vi.mock("crawclaw/plugin-sdk/security-runtime", async () => {
  const actual = await vi.importActual<typeof import("crawclaw/plugin-sdk/security-runtime")>(
    "crawclaw/plugin-sdk/security-runtime",
  );
  return {
    ...actual,
