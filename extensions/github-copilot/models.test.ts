...
vi.mock("crawclaw/plugin-sdk/provider-model-shared", () => ({
...
vi.mock("crawclaw/plugin-sdk/json-store", () => ({
  loadJsonFile,
  saveJsonFile,
}));

vi.mock("crawclaw/plugin-sdk/state-paths", () => ({
  resolveStateDir: () => "/tmp/crawclaw-state",
}));

import type { ProviderResolveDynamicModelContext } from "crawclaw/plugin-sdk/core";
...
describe("github-copilot token", () => {
  const cachePath = "/tmp/crawclaw-state/credentials/github-copilot.token.json";
