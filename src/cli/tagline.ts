const DEFAULT_TAGLINE = "All your chats, one CrawClaw.";
...
const TAGLINES: string[] = [
  ...
  "I'll season your workflow like a crab boil: messy, delicious, effective.",
  ...
  "Built by crabs, for humans. Don't question the hierarchy.",
  ...
  "You had me at 'crawclaw gateway start.'",
...
export function pickTagline(options: TaglineOptions = {}): string {
  ...
  const override = env?.CRAWCLAW_TAGLINE_INDEX;
