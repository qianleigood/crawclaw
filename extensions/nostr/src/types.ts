...
import { normalizeSecretInputString, type SecretInput } from "crawclaw/plugin-sdk/secret-input";
...
function resolveConfiguredDefaultNostrAccountId(cfg: CrawClawConfig): string | undefined {
 ...
 */
export function listNostrAccountIds(cfg: CrawClawConfig): string[] {
  const nostrCfg = (cfg.channels as Record<string, unknown> | undefined)?.nostr as
    | NostrAccountConfig
    | undefined;
 ...
 */
export function resolveDefaultNostrAccountId(cfg: CrawClawConfig): string {
