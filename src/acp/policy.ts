...
export function isAcpEnabledByPolicy(cfg: CrawClawConfig): boolean {
  return cfg.acp?.enabled !== false;
}

export function resolveAcpDispatchPolicyState(cfg: CrawClawConfig): AcpDispatchPolicyState {
...
export function isAcpDispatchEnabledByPolicy(cfg: CrawClawConfig): boolean {
  return resolveAcpDispatchPolicyState(cfg) === "enabled";
}

export function resolveAcpDispatchPolicyMessage(cfg: CrawClawConfig): string | null {
...
export function resolveAcpDispatchPolicyError(cfg: CrawClawConfig): AcpRuntimeError | null {
...
export function isAcpAgentAllowedByPolicy(cfg: CrawClawConfig, agentId: string): boolean {
