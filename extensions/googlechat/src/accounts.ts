...
import { isSecretRef, type CrawClawConfig } from "crawclaw/plugin-sdk/core";
import { safeParseJsonWithSchema, safeParseWithSchema } from "crawclaw/plugin-sdk/extension-shared";
import { z } from "zod";
...
export function listEnabledGoogleChatAccounts(cfg: CrawClawConfig): ResolvedGoogleChatAccount[] {
