---
summary: "Use Xiaomi MiMo models with CrawClaw"
read_when:
  - You want Xiaomi MiMo models in CrawClaw
...
Xiaomi MiMo is the API platform for **MiMo** models. CrawClaw uses the Xiaomi
