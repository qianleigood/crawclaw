...
import * as replyRuntime from "crawclaw/plugin-sdk/reply-runtime";
import { resolveChunkMode, resolveTextChunkLimit } from "crawclaw/plugin-sdk/reply-runtime";
...
type DiscordConfig = NonNullable<CrawClawConfig["channels"]>["discord"];
