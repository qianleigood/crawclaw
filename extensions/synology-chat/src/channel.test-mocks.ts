...
vi.mock("crawclaw/plugin-sdk/setup", async () => {
  const actual = await vi.importActual<object>("crawclaw/plugin-sdk/setup");
  return {
    ...actual,
...
vi.mock("crawclaw/plugin-sdk/channel-config-schema", async () => {
  const actual = await vi.importActual<object>("crawclaw/plugin-sdk/channel-config-schema");
  return {
    ...actual,
...
vi.mock("crawclaw/plugin-sdk/webhook-ingress", async () => {
  const actual = await vi.importActual<object>("crawclaw/plugin-sdk/webhook-ingress");
  return {
    ...actual,
