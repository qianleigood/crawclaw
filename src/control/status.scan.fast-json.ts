...
let commandSecretTargetsModulePromise:
  | Promise<typeof import("../terminal/command-secret-targets.js")>
  | undefined;
let commandSecretGatewayModulePromise:
  | Promise<typeof import("../terminal/command-secret-gateway.js")>
  | undefined;
...
function loadCommandSecretTargetsModule() {
  commandSecretTargetsModulePromise ??= import("../terminal/command-secret-targets.js");
  return commandSecretTargetsModulePromise;
}

function loadCommandSecretGatewayModule() {
  commandSecretGatewayModulePromise ??= import("../terminal/command-secret-gateway.js");
