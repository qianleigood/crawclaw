---
summary: "Schema-accurate configuration examples for common CrawClaw setups"
read_when:
  - Learning how to configure CrawClaw
...
Save to `~/.crawclaw/crawclaw.json` and you can DM the bot from that number.
...
For QQBot, DingTalk, Feishu, Weixin, and native/plugin chat channels, sender authorization is ID-first by default.
