...
import { AcpRuntimeError } from "crawclaw/plugin-sdk/acp-runtime";
...
let runtimeEnvModule: typeof import("crawclaw/plugin-sdk/runtime-env");
...
function createConfigWithDiscordAccount(overrides: Record<string, unknown> = {}): CrawClawConfig {
  return {
    channels: {
      discord: {
        accounts: {
...
vi.mock("crawclaw/plugin-sdk/plugin-runtime", async () => {
  const actual = await vi.importActual<typeof import("crawclaw/plugin-sdk/plugin-runtime")>(
...
describe("monitorDiscordProvider", () => {
  ...
  beforeAll(async () => {
    ...
    runtimeEnvModule = await import("crawclaw/plugin-sdk/runtime-env");
