...
describe("commands registry", () => {
  ...
  it("exposes native specs", () => {
    ...
    expect(specs.find((spec) => spec.name === "verify")).toBeFalsy();
  ...
  it("normalizes telegram-style command mentions for the current bot", () => {
    expect(normalizeCommandBody("/help@crawclaw", { botUsername: "crawclaw" })).toBe("/help");
    expect(
      normalizeCommandBody("/help@crawclaw args", {
        botUsername: "crawclaw",
      }),
    ).toBe("/help args");
    expect(
      normalizeCommandBody("/help@crawclaw: args", {
  ...
  it("keeps telegram-style command mentions for other bots", () => {
    expect(normalizeCommandBody("/help@otherbot", { botUsername: "crawclaw" })).toBe(
      "/help@otherbot",
    );
  });
