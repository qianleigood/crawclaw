...
import type {
  ...
  CrawClawPluginApi as CoreCrawClawPluginApi,
  PluginRuntime as CorePluginRuntime,
} from "crawclaw/plugin-sdk/core";
import * as providerEntrySdk from "crawclaw/plugin-sdk/provider-entry";
...
import type {
  ...
  CrawClawPluginApi as SharedCrawClawPluginApi,
...
const representativeRuntimeSmokeSubpaths = ["channel-id", "conversation-runtime"] as const;
...
describe("plugin-sdk subpath exports", () => {
  ...
  it("exports channel id helpers from the dedicated subpath", () => {
    expectSourceMentions("channel-id", ["ChannelId", "normalizeChannelId"]);
  ...
  it("keeps shared plugin-sdk types aligned", () => {
    ...
    expectTypeOf<CoreCrawClawPluginApi>().toMatchTypeOf<CrawClawPluginApi>();
    expectTypeOf<CorePluginRuntime>().toMatchTypeOf<PluginRuntime>();
    expectTypeOf<CoreChannelMessageActionContext>().toMatchTypeOf<ChannelMessageActionContext>();
    expectTypeOf<CoreCrawClawPluginApi>().toMatchTypeOf<SharedCrawClawPluginApi>();
  ...
  it("keeps runtime entry subpaths importable", async () => {
    const [
      ...
      importResolvedPluginSdkSubpath("crawclaw/plugin-sdk/core"),
      importResolvedPluginSdkSubpath("crawclaw/plugin-sdk/channel-actions"),
      importResolvedPluginSdkSubpath("crawclaw/plugin-sdk/global-singleton"),
      importResolvedPluginSdkSubpath("crawclaw/plugin-sdk/text-runtime"),
      importResolvedPluginSdkSubpath("crawclaw/plugin-sdk/huggingface"),
      importResolvedPluginSdkSubpath("crawclaw/plugin-sdk/plugin-entry"),
      importResolvedPluginSdkSubpath("crawclaw/plugin-sdk/channel-lifecycle"),
      importResolvedPluginSdkSubpath("crawclaw/plugin-sdk/channel-pairing"),
      importResolvedPluginSdkSubpath("crawclaw/plugin-sdk/channel-reply-pipeline"),
      ...representativeRuntimeSmokeSubpaths.map((id) =>
        importResolvedPluginSdkSubpath(`crawclaw/plugin-sdk/${id}`),
      ),
    ]);
