...
import type {
  CrawClawConfig as CrawClawConfig,
  SlackReactionNotificationMode,
} from "crawclaw/plugin-sdk/config-runtime";
import { resolveSessionKey, type SessionScope } from "crawclaw/plugin-sdk/config-runtime";
import type { DmPolicy, GroupPolicy } from "crawclaw/plugin-sdk/config-runtime";
import { createDedupeCache } from "crawclaw/plugin-sdk/core";
...
export type SlackMonitorContext = {
  ...
  slashCommand: Required<import("crawclaw/plugin-sdk/config-runtime").SlackSlashCommandConfig>;
  textLimit: number;
