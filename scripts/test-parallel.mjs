...
if (rawCli.showHelp) {
  console.log(
    [
      ...
      "",
      "Runs the planner-backed CrawClaw test wrapper.",
      "",
      "Wrapper flags:",
      ...
      "  --surface <name>       Select a surface: unit, extensions, contracts, gateway",
      ...
      "",
      "Environment:",
      "  CRAWCLAW_TEST_LIST_LANES=1          Print the resolved plan before execution",
      "  CRAWCLAW_TEST_SHOW_POOL_DECISION=1  Include thread/fork pool decisions in diagnostics",
    ].join("\n"),
  );
  process.exit(0);
}
...
if (process.env.CRAWCLAW_TEST_LIST_LANES === "1" || rawCli.plan) {
