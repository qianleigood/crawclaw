...
read_when:
  - You want to use Vercel AI Gateway with CrawClaw
...
- CrawClaw auto-discovers the Gateway `/v1/models` catalog, so `/models vercel-ai-gateway`
...
CrawClaw accepts Vercel Claude shorthand model refs and normalizes them at
runtime:
