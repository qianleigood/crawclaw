...
function buildConfig(
  execApprovals?: NonNullable<NonNullable<CrawClawConfig["channels"]>["slack"]>["execApprovals"],
  channelOverrides?: Partial<NonNullable<NonNullable<CrawClawConfig["channels"]>["slack"]>>,
): CrawClawConfig {
  return {
    channels: {
      slack: {
