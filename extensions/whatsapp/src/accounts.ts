...
export function listWhatsAppAuthDirs(cfg: CrawClawConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: CrawClawConfig): boolean {
...
export function resolveWhatsAppAuthDir(params: { cfg: CrawClawConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: CrawClawConfig): ResolvedWhatsAppAccount[] {
