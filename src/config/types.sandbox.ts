...
export type SandboxBrowserSettings = {
  ...
  image?: string;
  containerPrefix?: string;
  /** Docker network for sandbox browser containers (default: crawclaw-sandbox-browser). */
  network?: string;
  cdpPort?: number;
  /** PinchTab orchestrator port when the sandbox browser image provides PinchTab. */
  pinchTabPort?: number;
