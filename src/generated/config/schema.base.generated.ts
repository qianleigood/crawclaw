// Auto-generated by crawclaw-runtime emit-base-config-schema. Do not edit directly.
...
export const GENERATED_BASE_CONFIG_SCHEMA = {
  ...
  uiHints: {
    ...
    "tools.exec.host": {
      label: "Exec Target",
      help: 'Selects execution target strategy for shell commands. Use "auto" for gateway execution, or pin "gateway" explicitly when you need a fixed surface.',
      tags: ["tools"],
    },
    "tools.exec.security": {
      label: "Exec Security",
      help: "Execution security posture selector controlling approval expectations for command execution. Keep strict security mode for untrusted prompts and relax only for trusted operator workflows.",
      tags: ["tools"],
    },
    "tools.exec.ask": {
      label: "Exec Ask",
    ...
    "tools.exec.pathPrepend": {
      ...
      help: "Directories to prepend to PATH for gateway exec runs.",
      tags: ["storage", "tools"],
    },
    "tools.exec.safeBins": {
    ...
    "plugins.enabled": {
      ...
      help: "Enable or disable plugin loading globally during startup and desktop config writes (default: true). Keep enabled only when plugin capabilities are required by your deployment.",
      tags: ["advanced"],
    },
    "plugins.allow": {
...
} as const satisfies ConfigSchemaResponse;
