...
function resolveVersionFromRuntimeSources(params: {
  ...
  const preferredCandidates =
    params.preference === "env-first"
      ? [params.env["CRAWCLAW_VERSION"], params.runtimeVersion]
      : [params.runtimeVersion, params.env["CRAWCLAW_VERSION"]];
  return (
    firstNonEmpty(
      ...preferredCandidates,
      params.env["CRAWCLAW_SERVICE_VERSION"],
...
// Single source of truth for the current CrawClaw version.
