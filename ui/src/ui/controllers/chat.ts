...
function maybeResetToolStream(state: ChatState) {
  ...
  const actionHost = state as ChatState & Partial<Parameters<typeof resetActionFeed>[0]>;
  if (
    Array.isArray(actionHost.chatActionFeed) &&
    actionHost.actionFeedById instanceof Map &&
    Array.isArray(actionHost.actionFeedOrder)
  ) {
    resetActionFeed(actionHost as Parameters<typeof resetActionFeed>[0]);
  }
}
...
export function handleChatEvent(state: ChatState, payload?: ChatEventPayload) {
  ...
  // See https://github.com/qianleigood/crawclaw/issues/1909
