...
通过一键模板在 Northflank 上部署 CrawClaw，然后在浏览器中完成设置。
...
7. 打开 CrawClaw 服务。
8. 打开公开的 CrawClaw URL，在 `/setup` 完成设置。
9. 在 `/crawclaw` 打开控制面板 UI。
...
4. 点击 **Run setup**。
5. 在 `https://<your-northflank-domain>/crawclaw` 打开控制面板 UI。

如果 Feishu 私信设置为配对模式，设置向导可以审批配对码。
