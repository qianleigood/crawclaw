...
function resolveImportedExternalId(message: unknown): string | undefined {
  ...
  const meta =
    "__crawclaw" in message &&
    (message as { __crawclaw?: unknown }).__crawclaw &&
    typeof (message as { __crawclaw?: unknown }).__crawclaw === "object"
      ? ((message as { __crawclaw?: Record<string, unknown> }).__crawclaw ?? {})
      : undefined;
