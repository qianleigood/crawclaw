...
export type SubagentRunRecord = {
  ...
  /** Terminal ACP wrapper transcript has been materialized for this run. */
  wrapperTranscriptMirroredAt?: number;
  /** Internal in-flight guard to avoid duplicate ACP transcript materialization. */
  wrapperTranscriptMirroring?: boolean;
  /**
