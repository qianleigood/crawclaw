...
- CrawClaw Desktop and the local Gateway API expose the full per-provider usage breakdown.
- Model/provider status surfaces include the same usage snapshot alongside provider config when available.
