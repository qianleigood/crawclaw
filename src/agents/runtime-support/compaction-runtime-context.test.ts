...
import {
  buildAgentCompactionRuntimeContext,
  resolveAgentCompactionTarget,
} from "./compaction-runtime-context.js";

describe("buildAgentCompactionRuntimeContext", () => {
  ...
  it("applies compaction.model override with provider/model format", () => {
    const result = buildAgentCompactionRuntimeContext({
      workspaceDir: "/tmp/workspace",
      agentDir: "/tmp/agent",
      config: {
