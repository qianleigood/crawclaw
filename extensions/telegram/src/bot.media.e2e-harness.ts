...
import type { GetReplyOptions, MsgContext } from "crawclaw/plugin-sdk/reply-runtime";
...
type FetchRemoteMediaFn = typeof import("crawclaw/plugin-sdk/media-runtime").fetchRemoteMedia;
...
export const telegramBotDepsForTest: TelegramBotDeps = {
  loadConfig: (() =>
    ...
    }) as CrawClawConfig) as TelegramBotDeps["loadConfig"],
...
export async function mockMediaRuntimeModuleForTest(
  importOriginal: () => Promise<typeof import("crawclaw/plugin-sdk/media-runtime")>,
) {
...
vi.mock("crawclaw/plugin-sdk/media-runtime", mockMediaRuntimeModuleForTest);
...
vi.doMock("crawclaw/plugin-sdk/agent-runtime", async (importOriginal) => {
