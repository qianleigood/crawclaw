...
function createCfg(): CrawClawConfig {
  return {
    channels: {
      telegram: {
        enabled: true,
...
function resolveAccount(cfg: CrawClawConfig, accountId: string): ResolvedTelegramAccount {
  return telegramPlugin.config.resolveAccount(cfg, accountId) as ResolvedTelegramAccount;
}

function createStartTelegramContext(cfg: CrawClawConfig, accountId: string) {
...
function startTelegramAccount(cfg: CrawClawConfig, accountId: string) {
...
function configureOpsProxyNetwork(cfg: CrawClawConfig) {
