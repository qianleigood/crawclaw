 ...
 *
 * Channel messages (native channels) already have timestamps via
...
/**
 * Build TimestampInjectionOptions from an CrawClawConfig.
 */
export function timestampOptsFromConfig(cfg: CrawClawConfig): TimestampInjectionOptions {
  return {
