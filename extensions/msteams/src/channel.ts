...
import { createMessageToolCardSchema } from "crawclaw/plugin-sdk/channel-actions";
import { createTopLevelChannelConfigAdapter } from "crawclaw/plugin-sdk/channel-config-helpers";
import type {
...
const resolveMSTeamsChannelConfig = (cfg: CrawClawConfig) => ({
...
export const msteamsPlugin: ChannelPlugin<ResolvedMSTeamsAccount, ProbeMSTeamsResult> =
  createChatChannelPlugin({
    ...
    security: {
      collectWarnings: projectConfigWarningCollector<{ cfg: CrawClawConfig }>(
