...
import { RUST_NATIVE_MEMORY_RUNTIME_DESCRIPTOR } from "../memory/engine/memory-runtime.js";
...
export const CACHE_GOVERNANCE_REGISTRY: CacheGovernanceDescriptor[] = [
  ...
  SESSION_STORE_CACHE_DESCRIPTOR,
  WEB_FETCH_RESPONSE_CACHE_DESCRIPTOR,
  RUST_NATIVE_MEMORY_RUNTIME_DESCRIPTOR,
  ROUTE_AGENT_LOOKUP_CACHE_DESCRIPTOR,
  ROUTE_EVALUATED_BINDINGS_CACHE_DESCRIPTOR,
  ROUTE_RESOLVED_ROUTE_CACHE_DESCRIPTOR,
