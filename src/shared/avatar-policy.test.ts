...
describe("avatar policy", () => {
  ...
  it("accepts workspace-relative avatar paths and rejects URI schemes", () => {
    expect(isWorkspaceRelativeAvatarPath("avatars/crawclaw.png")).toBe(true);
    expect(isWorkspaceRelativeAvatarPath("C:\\\\avatars\\\\crawclaw.png")).toBe(true);
  ...
  it("detects avatar-like path strings", () => {
    expect(looksLikeAvatarPath("avatars/crawclaw.svg")).toBe(true);
    expect(looksLikeAvatarPath("crawclaw.webp")).toBe(true);
