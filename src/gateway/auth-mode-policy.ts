...
export function hasAmbiguousGatewayAuthModeConfig(cfg: CrawClawConfig): boolean {
...
export function assertExplicitGatewayAuthModeWhenBothConfigured(cfg: CrawClawConfig): void {
