...
import type { ChannelSetupAdapter, ChannelSetupDmPolicy } from "crawclaw/plugin-sdk/setup";
...
export const TELEGRAM_USER_ID_HELP_LINES = [
  `1) DM your bot, then read from.id in \`${formatCliCommand("crawclaw logs --follow")}\` (safest)`,
