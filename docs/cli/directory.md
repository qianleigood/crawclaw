---
summary: "CLI reference for `crawclaw directory` (self, peers, groups)"
read_when:
...
- `directory` is meant to help you find IDs you can paste into other commands (especially `crawclaw message send --target ...`).
