...
<Columns>
  ...
  <Card title="Webサーフェス" href="/web" icon="layout-dashboard">
    残っているWebChatとブラウザアクセス方法を確認します。
  </Card>
</Columns>
...
<Columns>
  ...
  <Card title="Webクライアント" icon="monitor">
    WebChatとブラウザアクセスの入口。
  </Card>
...
Gateway起動後は、残っているWebサーフェスまたはローカル端末から利用します。

- ローカル端末: `crawclaw tui`
- ブラウザアクセス: [Webサーフェス](/web)
