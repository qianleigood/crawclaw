...
describe("resolveApiKeyForProfile fallback to main agent", () => {
  ...
  beforeEach(async () => {
    ...
    // Set environment variables so resolveCrawClawAgentDir() returns mainAgentDir
    process.env.CRAWCLAW_STATE_DIR = tmpDir;
    process.env.CRAWCLAW_AGENT_DIR = mainAgentDir;
