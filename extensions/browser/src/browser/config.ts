...
import {
  ...
  DEFAULT_CRAWCLAW_BROWSER_ENABLED,
...
function normalizeHexColor(raw: string | undefined) {
  ...
  if (!value) {
    return DEFAULT_CRAWCLAW_BROWSER_COLOR;
  }
...
/**
 * Ensure the default "crawclaw" profile exists in the profiles map.
...
function ensureDefaultProfile(
  ...
  if (!result[DEFAULT_CRAWCLAW_BROWSER_PROFILE_NAME]) {
    result[DEFAULT_CRAWCLAW_BROWSER_PROFILE_NAME] = {
