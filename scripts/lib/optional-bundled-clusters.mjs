...
export const OPTIONAL_BUNDLED_BUILD_ENV = "CRAWCLAW_INCLUDE_OPTIONAL_BUNDLED";
...
export function hasReleasedBundledInstall(packageJson) {
  return (
    typeof packageJson?.crawclaw?.install?.npmSpec === "string" &&
    packageJson.crawclaw.install.npmSpec.trim().length > 0
  );
}
