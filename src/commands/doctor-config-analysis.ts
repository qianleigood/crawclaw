...
export function stripUnknownConfigKeys(config: CrawClawConfig): {
  config: CrawClawConfig;
  removed: string[];
} {
  const parsed = CrawClawSchema.safeParse(config);
  if (parsed.success) {
...
export function noteOpencodeProviderOverrides(cfg: CrawClawConfig): void {
