...
export const routes: RouteRecordRaw[] = [
  ...
  },
  {
    ...
    children: [
      {
        path: 'welcome',
        name: 'DesktopOnboarding',
        component: () => import('@/views/desktop/DesktopOnboardingPage.vue'),
        meta: { titleKey: 'routes.desktopOnboarding', hidden: true, gateway: 'crawclaw' },
      },
      {
        path: '',
        name: 'Dashboard',
      ...
      },
      {
        ...
        meta: { titleKey: 'routes.memory', icon: 'BookOutline', gateway: 'crawclaw', desktopAdvanced: true },
      },
      {
        path: 'cron',
        name: 'Cron',
        component: () => import('@/views/cron/CronPage.vue'),
        meta: { titleKey: 'routes.cron', icon: 'CalendarOutline', gateway: 'crawclaw', desktopAdvanced: true },
      },
      {
        path: 'workflows',
        name: 'Workflows',
        component: () => import('@/views/workflows/WorkflowsPage.vue'),
        meta: { titleKey: 'routes.workflows', icon: 'GitNetworkOutline', gateway: 'crawclaw', desktopAdvanced: true },
      },
      {
        path: 'comfyui',
        name: 'ComfyUI',
        component: () => import('@/views/comfyui/ComfyUiPage.vue'),
        meta: { titleKey: 'routes.comfyui', icon: 'ImagesOutline', gateway: 'crawclaw', desktopAdvanced: true },
      },
      {
        path: 'models',
        name: 'Models',
      ...
      },
      {
        ...
        meta: { titleKey: 'routes.voiceModule', icon: 'VolumeHighOutline', gateway: 'crawclaw', desktopAdvanced: true },
      },
      {
        path: 'esp32',
        name: 'ESP32',
        component: () => import('@/views/esp32/ESP32Page.vue'),
        meta: { titleKey: 'routes.esp32', icon: 'HardwareChipOutline', gateway: 'crawclaw', desktopAdvanced: true },
      },
      {
        path: 'channels',
        name: 'Channels',
      ...
      },
      {
        ...
        meta: { titleKey: 'routes.skills', icon: 'ExtensionPuzzleOutline', gateway: 'crawclaw', desktopAdvanced: true },
      },
      {
        path: 'tools',
      ...
      },
      {
        ...
        meta: { titleKey: 'routes.terminal', icon: 'TerminalOutline', gateway: 'crawclaw', desktopAdvanced: true },
      },
      {
        path: 'remote-desktop',
        name: 'RemoteDesktop',
        component: () => import('@/views/remote-desktop/RemoteDesktopPage.vue'),
        meta: { titleKey: 'routes.remoteDesktop', icon: 'DesktopOutline', gateway: 'crawclaw', desktopAdvanced: true },
      },
      {
        path: 'files',
        name: 'Files',
        component: () => import('@/views/files/FilesPage.vue'),
        meta: { titleKey: 'routes.files', icon: 'FolderOutline', gateway: 'crawclaw', desktopAdvanced: true },
      },
      {
        path: 'agents',
        name: 'Agents',
        component: () => import('@/views/agents/AgentsPage.vue'),
        meta: { titleKey: 'routes.agents', icon: 'PeopleOutline', gateway: 'crawclaw', desktopAdvanced: true },
      },
      {
        path: 'office',
        name: 'Office',
        component: () => import('@/views/office/OfficePage.vue'),
        meta: { titleKey: 'routes.office', icon: 'ConstructOutline', gateway: 'crawclaw', desktopAdvanced: true },
      },
      {
        path: 'myworld',
        name: 'MyWorld',
        component: () => import('@/views/myworld/MyWorldPage.vue'),
        meta: { titleKey: 'routes.myworld', icon: 'StorefrontOutline', gateway: 'crawclaw', desktopAdvanced: true },
      },
      {
        path: 'backup',
        name: 'Backup',
        component: () => import('@/views/backup/BackupPage.vue'),
        meta: { titleKey: 'routes.backup', icon: 'ArchiveOutline', gateway: 'crawclaw', desktopAdvanced: true },
      },
      {
        path: 'monitor',
        name: 'Monitor',
        component: () => import('@/views/monitor/MonitorPage.vue'),
        meta: { titleKey: 'routes.monitor', icon: 'PulseOutline', gateway: 'crawclaw', desktopAdvanced: true },
      },
      {
        path: 'hermes',
