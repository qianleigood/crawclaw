...
Official Voice Call plugin for **CrawClaw**.
...
Docs: `https://docs.crawclaw.ai/plugins/voice-call`
Plugin system: `https://docs.crawclaw.ai/plugin`
...
```bash
PLUGIN_HOME=~/.crawclaw/extensions
mkdir -p "$PLUGIN_HOME"
...
- advanced webhook, streaming, and tunnel notes: `https://docs.crawclaw.ai/plugins/voice-call`

## Stale call reaper

See the plugin docs for recommended ranges and production examples:
`https://docs.crawclaw.ai/plugins/voice-call#stale-call-reaper`
