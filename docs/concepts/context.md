...
read_when:
  - You want to understand what “context” means in CrawClaw
...
“Context” is **everything CrawClaw sends to the model for a run**. It is bounded by the model’s **context window** (token limit).

Beginner mental model:

- **System prompt** (CrawClaw-built): rules, tools, skills list, time/runtime, and injected workspace files.
...
- [Context Engine Removal](/concepts/context-engine) — migration note for the removed legacy surface
