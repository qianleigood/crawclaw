...
export type WebFetchConfig = NonNullable<CrawClawConfig["tools"]>["web"] extends infer Web
...
export function resolveWebFetchConfig(cfg?: CrawClawConfig): WebFetchConfig {
