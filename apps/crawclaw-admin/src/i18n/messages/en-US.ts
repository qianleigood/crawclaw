export default {
  ...
  pages: {
    ...
    settings: {
      ...
      desktopRuntime: 'Local Runtime',
      desktopRuntimeHint: 'CrawClaw Desktop manages the local Gateway service from the bundled runtime. Closing the window does not stop the Gateway.',
      desktopRuntimeStatusFailed: 'Failed to read local runtime status',
      desktopServiceStart: 'Start Service',
      desktopServiceStop: 'Stop Service',
      desktopServiceRestart: 'Restart Service',
      desktopServiceActionSuccess: 'Gateway service command completed',
      desktopServiceActionFailed: 'Gateway service command failed',
      desktopLogs: 'Gateway Logs',
      desktopLogsEmpty: 'No Gateway logs found yet.',
      desktopLogsFailed: 'Failed to read Gateway logs',
