...
import { buildOauthProviderAuthResult } from "crawclaw/plugin-sdk/provider-auth-result";
import { fetchGeminiUsage } from "crawclaw/plugin-sdk/provider-usage";
...
export function registerGoogleGeminiCliProvider(api: CrawClawPluginApi) {
