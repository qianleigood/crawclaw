...
export const ControlUiMethodContract = {
  ...
  "channels.setup.surface": defineControlUiMethod({
    ...
    paramsSchema: ChannelsSetupSurfaceParamsSchema,
    resultSchema: ChannelsSetupSurfaceResultSchema,
    requiredScopes: ["operator.read"],
    stability: "stable",
  }),
  "channels.account.login.start": defineControlUiMethod({
    method: "channels.account.login.start",
    paramsSchema: ChannelsAccountLoginStartParamsSchema,
    resultSchema: ChannelsAccountLoginStartResultSchema,
    requiredScopes: ["operator.admin"],
    stability: "stable",
  }),
  "channels.account.login.wait": defineControlUiMethod({
    method: "channels.account.login.wait",
    paramsSchema: ChannelsAccountLoginWaitParamsSchema,
    resultSchema: ChannelsAccountLoginWaitResultSchema,
    requiredScopes: ["operator.admin"],
    stability: "stable",
  }),
  "channels.account.reconnect": defineControlUiMethod({
    method: "channels.account.reconnect",
    paramsSchema: ChannelsAccountReconnectParamsSchema,
    resultSchema: ChannelsAccountReconnectResultSchema,
    requiredScopes: ["operator.admin"],
    stability: "stable",
  }),
  "channels.config.get": defineControlUiMethod({
    method: "channels.config.get",
    paramsSchema: ChannelsConfigGetParamsSchema,
    resultSchema: ChannelsConfigSnapshotSchema,
    requiredScopes: ["operator.read"],
    stability: "stable",
  }),
  "channels.config.schema": defineControlUiMethod({
    method: "channels.config.schema",
    paramsSchema: ChannelsConfigSchemaParamsSchema,
    resultSchema: ChannelsConfigSchemaResultSchema,
    requiredScopes: ["operator.read"],
    stability: "stable",
  }),
  "channels.config.patch": defineControlUiMethod({
    method: "channels.config.patch",
    paramsSchema: ChannelsConfigPatchParamsSchema,
    resultSchema: ChannelsConfigWriteResultSchema,
    requiredScopes: ["operator.admin"],
    stability: "stable",
    effects: {
      writesConfig: true,
  ...
  "channels.config.apply": defineControlUiMethod({
    method: "channels.config.apply",
    paramsSchema: ChannelsConfigApplyParamsSchema,
    resultSchema: ChannelsConfigWriteResultSchema,
    requiredScopes: ["operator.admin"],
    stability: "stable",
    effects: {
  ...
  "channels.account.verify": defineControlUiMethod({
    method: "channels.account.verify",
    paramsSchema: ChannelsAccountVerifyParamsSchema,
    resultSchema: ChannelsAccountVerifyResultSchema,
    requiredScopes: ["operator.read"],
    stability: "stable",
  }),
  "channels.account.logout": defineControlUiMethod({
    method: "channels.account.logout",
    paramsSchema: ChannelsAccountLogoutParamsSchema,
    resultSchema: ChannelsAccountLogoutResultSchema,
    requiredScopes: ["operator.admin"],
    stability: "stable",
  }),
