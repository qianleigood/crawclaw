...
This is a living document maintained by the CrawClaw community. See [CONTRIBUTING-THREAT-MODEL.md](/security/CONTRIBUTING-THREAT-MODEL) for guidelines on contributing:
...
This threat model documents adversarial threats to the CrawClaw AI agent platform and ClawHub skill marketplace, using the MITRE ATLAS framework designed specifically for AI/ML systems.
...
| **Description**         | Attacker scans for exposed CrawClaw gateway endpoints                |
...
| **Affected Components** | ~/.crawclaw/credentials/, config storage                    |
...
| ATLAS ID      | Technique Name                 | CrawClaw Threats                                                 |
| ------------- | ------------------------------ | ---------------------------------------------------------------- |
...
| **ClawHub**          | CrawClaw's skill marketplace                              |
| **Gateway**          | CrawClaw's message routing and authentication layer       |
| **MCP**              | Model Context Protocol - tool provider interface          |
| **Prompt Injection** | Attack where malicious instructions are embedded in input |
| **Skill**            | Downloadable extension for CrawClaw agents                |
| **SSRF**             | Server-Side Request Forgery                               |

---

_This threat model is a living document. Report security issues to security@crawclaw.ai_
