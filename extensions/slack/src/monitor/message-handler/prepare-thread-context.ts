import { formatInboundEnvelope } from "crawclaw/plugin-sdk/channel-inbound";
import type { ContextVisibilityMode } from "crawclaw/plugin-sdk/config-runtime";
import { readSessionUpdatedAt } from "crawclaw/plugin-sdk/config-runtime";
...
export async function resolveSlackThreadContextData(params: {
  ...
  envelopeOptions: ReturnType<
    typeof import("crawclaw/plugin-sdk/channel-inbound").resolveEnvelopeFormatOptions
  >;
