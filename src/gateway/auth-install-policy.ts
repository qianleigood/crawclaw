...
type GatewayInstallAuthMode = NonNullable<NonNullable<CrawClawConfig["gateway"]>["auth"]>["mode"];
...
function hasConfiguredGatewayPasswordForInstall(cfg: CrawClawConfig): boolean {
