...
function resolveAnthropicOpusThinking(cfg: CrawClawConfig) {
...
function createProviderWithModelsConfig(provider: string, models: Array<Record<string, unknown>>) {
  ...
  } as Partial<CrawClawConfig>;
}

function resolveConfiguredRefForTest(cfg: Partial<CrawClawConfig>) {
...
describe("model-selection", () => {
  ...
  describe("buildModelAliasIndex", () => {
    it("should build alias index from config", () => {
      const cfg: Partial<CrawClawConfig> = {
        agents: {
          defaults: {
            models: {
