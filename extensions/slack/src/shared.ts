...
import { getChatChannelMeta, type ChannelPlugin, type CrawClawConfig } from "./runtime-api.js";

export const SLACK_CHANNEL = "slack" as const;

function buildSlackManifest(botName: string) {
  const safeName = botName.trim() || "CrawClaw";
  const manifest = {
    display_information: {
      name: safeName,
      description: `${safeName} connector for CrawClaw`,
    },
    features: {
      bot_user: {
...
export function buildSlackSetupLines(botName = "CrawClaw"): string[] {
  return [
