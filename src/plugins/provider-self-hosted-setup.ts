...
export function applyProviderDefaultModel(cfg: CrawClawConfig, modelRef: string): CrawClawConfig {
...
function buildOpenAICompatibleSelfHostedProviderConfig(params: {
  ...
  contextWindow?: number;
  maxTokens?: number;
}): { config: CrawClawConfig; modelId: string; modelRef: string; profileId: string } {
