...
function fallbackRuntimeCoreTools(): PluginTool[] {
  return [
    ...
    ['knowledge_recall', 'knowledge_recall', 'Search Hindsight memory banks', 'memory', true],
    ['knowledge_reflect', 'knowledge_reflect', 'Synthesize knowledge from Hindsight memory', 'memory', true],
    ['knowledge_ingest', 'knowledge_ingest', 'Ingest content into Hindsight memory', 'memory', false],
    ['knowledge_model_list', 'knowledge_model_list', 'List Hindsight mental models', 'memory', true],
    ['knowledge_model_create', 'knowledge_model_create', 'Create Hindsight mental models', 'memory', false],
