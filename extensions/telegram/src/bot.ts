import { resolveDefaultAgentId } from "crawclaw/plugin-sdk/agent-runtime";
import {
...
import { loadSessionStore, resolveStorePath } from "crawclaw/plugin-sdk/config-runtime";
import {
      ...
      const abortWith = (signal: unknown) => {
        const reason =
          signal && typeof signal === "object" && "reason" in signal
            ? (signal as { readonly reason?: unknown }).reason
            : undefined;
