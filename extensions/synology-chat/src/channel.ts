/**
 * Synology Chat Channel Plugin for CrawClaw.
 *
...
import { attachChannelToResult } from "crawclaw/plugin-sdk/channel-send-result";
import { createChatChannelPlugin, type ChannelPlugin } from "crawclaw/plugin-sdk/core";
import { createEmptyChannelDirectoryAdapter } from "crawclaw/plugin-sdk/directory-runtime";
...
const resolveSynologyChatDmPolicy = createScopedDmSecurityResolver<ResolvedSynologyChatAccount>({
  ...
  approveHint: "crawclaw pairing approve synology-chat <code>",
...
> & {
  pairing: {
    ...
    notifyApproval: (params: { cfg: CrawClawConfig; id: string }) => Promise<void>;
  };
  security: {
    resolveDmPolicy: (params: { cfg: CrawClawConfig; account: ResolvedSynologyChatAccount }) => {
  ...
  return createChatChannelPlugin({
    base: {
      ...
      meta: {
        ...
        blurb: "Connect your Synology NAS Chat to CrawClaw",
        order: 90,
      },
      capabilities: {
    ...
    pairing: {
      text: {
        ...
        message: "CrawClaw: your access has been approved.",
