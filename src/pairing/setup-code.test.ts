...
describe("pairing setup code", () => {
  ...
  beforeEach(() => {
    vi.stubEnv("CRAWCLAW_GATEWAY_TOKEN", "");
    vi.stubEnv("CRAWCLAW_GATEWAY_PASSWORD", "");
    vi.stubEnv("CRAWCLAW_GATEWAY_PORT", "");
  });
  ...
  it.each([
    ...
    {
      name: "uses CRAWCLAW_GATEWAY_PASSWORD without resolving configured password SecretRef",
      auth: {
        mode: "password",
  ...
  it.each([
    ...
    },
    {
      ...
      options: {
        env: {
          CRAWCLAW_GATEWAY_TOKEN: "new-token",
        },
