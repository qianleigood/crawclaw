...
>({
  ...
  resolveParams: (_cfg: CrawClawConfig, api) => ({
    providerId: "xai",
    api,
...
export function applyXaiProviderConfig(cfg: CrawClawConfig): CrawClawConfig {
  return xaiPresetAppliers.applyProviderConfig(cfg, "openai-responses");
}

export function applyXaiResponsesApiConfig(cfg: CrawClawConfig): CrawClawConfig {
  return xaiPresetAppliers.applyProviderConfig(cfg, "openai-responses");
}

export function applyXaiConfig(cfg: CrawClawConfig): CrawClawConfig {
