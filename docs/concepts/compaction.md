---
summary: "How CrawClaw summarizes long conversations to stay within model limits"
read_when:
...
When a conversation approaches that limit, CrawClaw **compacts** older messages
...
CrawClaw compacts and retries).

<Info>
Before compacting, CrawClaw automatically reminds the agent to save important
