...
export type ChannelSetupWizardStatus = {
  ...
  resolveConfigured: (params: { cfg: CrawClawConfig }) => boolean | Promise<boolean>;
...
export type ChannelSetupWizardEnvShortcut = {
  ...
  isAvailable: (params: { cfg: CrawClawConfig; accountId: string }) => boolean;
  apply: (params: {
    cfg: CrawClawConfig;
    accountId: string;
...
export type ChannelSetupWizardCredential = {
  ...
  keepPrompt: string;
  inputPrompt: string;
  allowEnv?: (params: { cfg: CrawClawConfig; accountId: string }) => boolean;
  inspect: (params: {
    cfg: CrawClawConfig;
    accountId: string;
...
export type ChannelSetupWizardGroupAccess = {
  ...
  currentPolicy: (params: { cfg: CrawClawConfig; accountId: string }) => ChannelAccessPolicy;
  currentEntries: (params: { cfg: CrawClawConfig; accountId: string }) => string[];
  updatePrompt: (params: { cfg: CrawClawConfig; accountId: string }) => boolean;
  setPolicy: (params: {
    cfg: CrawClawConfig;
    accountId: string;
...
export type ChannelSetupWizard = {
  ...
  disable?: (cfg: CrawClawConfig) => CrawClawConfig;
