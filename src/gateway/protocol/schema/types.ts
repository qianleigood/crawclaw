...
export type AgentInspectParams = SchemaType<"AgentInspectParams">;
export type AgentInspectionTimelineEntry = SchemaType<"AgentInspectionTimelineEntry">;
export type AgentInspectionSnapshot = SchemaType<"AgentInspectionSnapshot">;
...
export type SessionsUsageEntry = SchemaType<"SessionsUsageEntry">;
export type SessionsUsageAggregates = SchemaType<"SessionsUsageAggregates">;
export type SessionsUsageResult = SchemaType<"SessionsUsageResult">;
export type SessionsUsageTimeSeriesParams = SchemaType<"SessionsUsageTimeSeriesParams">;
export type SessionsUsageTimePoint = SchemaType<"SessionsUsageTimePoint">;
export type SessionsUsageTimeSeriesResult = SchemaType<"SessionsUsageTimeSeriesResult">;
export type SessionsUsageLogsParams = SchemaType<"SessionsUsageLogsParams">;
export type SessionLogEntry = SchemaType<"SessionLogEntry">;
export type SessionsUsageLogsResult = SchemaType<"SessionsUsageLogsResult">;
...
export type ChannelsAccountTargetParams = SchemaType<"ChannelsAccountTargetParams">;
export type ChannelsAccountLoginStartParams = SchemaType<"ChannelsAccountLoginStartParams">;
export type ChannelsAccountLoginStartResult = SchemaType<"ChannelsAccountLoginStartResult">;
export type ChannelsAccountLoginWaitParams = SchemaType<"ChannelsAccountLoginWaitParams">;
export type ChannelsAccountLoginWaitResult = SchemaType<"ChannelsAccountLoginWaitResult">;
export type ChannelsAccountReconnectParams = SchemaType<"ChannelsAccountReconnectParams">;
export type ChannelsAccountReconnectResult = SchemaType<"ChannelsAccountReconnectResult">;
export type ChannelsConfigGetParams = SchemaType<"ChannelsConfigGetParams">;
export type ChannelsConfigSnapshot = SchemaType<"ChannelsConfigSnapshot">;
export type ChannelsConfigSchemaParams = SchemaType<"ChannelsConfigSchemaParams">;
export type ChannelsConfigSchemaResult = SchemaType<"ChannelsConfigSchemaResult">;
export type ChannelsConfigPatchParams = SchemaType<"ChannelsConfigPatchParams">;
export type ChannelsConfigApplyParams = SchemaType<"ChannelsConfigApplyParams">;
export type ChannelsConfigWriteResult = SchemaType<"ChannelsConfigWriteResult">;
export type ChannelsAccountVerifyParams = SchemaType<"ChannelsAccountVerifyParams">;
export type ChannelsAccountVerifyResult = SchemaType<"ChannelsAccountVerifyResult">;
export type ChannelsAccountLogoutParams = SchemaType<"ChannelsAccountLogoutParams">;
export type ChannelsAccountLogoutResult = SchemaType<"ChannelsAccountLogoutResult">;
...
export type UsageWindow = SchemaType<"UsageWindow">;
export type ProviderUsageSnapshot = SchemaType<"ProviderUsageSnapshot">;
export type UsageStatusResult = SchemaType<"UsageStatusResult">;
export type UsageCostParams = SchemaType<"UsageCostParams">;
export type CostUsageTotals = SchemaType<"CostUsageTotals">;
export type CostUsageDailyEntry = SchemaType<"CostUsageDailyEntry">;
export type CostUsageSummary = SchemaType<"CostUsageSummary">;
export type SessionOrigin = SchemaType<"SessionOrigin">;
export type SessionMessageCounts = SchemaType<"SessionMessageCounts">;
export type SessionToolUsage = SchemaType<"SessionToolUsage">;
export type SessionModelUsage = SchemaType<"SessionModelUsage">;
export type SessionLatencyStats = SchemaType<"SessionLatencyStats">;
export type SessionDailyLatency = SchemaType<"SessionDailyLatency">;
export type SessionDailyModelUsage = SchemaType<"SessionDailyModelUsage">;
export type WorkflowFieldSpec = SchemaType<"WorkflowFieldSpec">;
export type WorkflowStepSpec = SchemaType<"WorkflowStepSpec">;
export type WorkflowSpec = SchemaType<"WorkflowSpec">;
export type WorkflowListEntry = SchemaType<"WorkflowListEntry">;
export type WorkflowExecutionStepRecord = SchemaType<"WorkflowExecutionStepRecord">;
export type WorkflowExecutionEventRecord = SchemaType<"WorkflowExecutionEventRecord">;
export type WorkflowExecutionWaitState = SchemaType<"WorkflowExecutionWaitState">;
export type WorkflowExecutionView = SchemaType<"WorkflowExecutionView">;
export type WorkflowDeploymentRecord = SchemaType<"WorkflowDeploymentRecord">;
export type WorkflowDefinitionDiff = SchemaType<"WorkflowDefinitionDiff">;
export type WorkflowVersionSummary = SchemaType<"WorkflowVersionSummary">;
export type WorkflowListParams = SchemaType<"WorkflowListParams">;
export type WorkflowListResult = SchemaType<"WorkflowListResult">;
export type WorkflowGetParams = SchemaType<"WorkflowGetParams">;
export type WorkflowGetResult = SchemaType<"WorkflowGetResult">;
export type WorkflowMatchParams = SchemaType<"WorkflowMatchParams">;
export type WorkflowVersionsParams = SchemaType<"WorkflowVersionsParams">;
export type WorkflowVersionsResult = SchemaType<"WorkflowVersionsResult">;
export type WorkflowDiffParams = SchemaType<"WorkflowDiffParams">;
export type WorkflowDiffResult = SchemaType<"WorkflowDiffResult">;
export type WorkflowUpdateParams = SchemaType<"WorkflowUpdateParams">;
export type WorkflowRunsParams = SchemaType<"WorkflowRunsParams">;
export type WorkflowRunsResult = SchemaType<"WorkflowRunsResult">;
export type WorkflowN8nGetParams = SchemaType<"WorkflowN8nGetParams">;
export type WorkflowN8nGetResult = SchemaType<"WorkflowN8nGetResult">;
export type WorkflowMutationParams = SchemaType<"WorkflowMutationParams">;
export type WorkflowMutationResult = SchemaType<"WorkflowMutationResult">;
export type WorkflowDeleteParams = SchemaType<"WorkflowDeleteParams">;
export type WorkflowDeleteResult = SchemaType<"WorkflowDeleteResult">;
export type WorkflowDeployParams = SchemaType<"WorkflowDeployParams">;
export type WorkflowRepublishParams = SchemaType<"WorkflowRepublishParams">;
export type WorkflowRollbackParams = SchemaType<"WorkflowRollbackParams">;
export type WorkflowRunParams = SchemaType<"WorkflowRunParams">;
export type WorkflowExecutionControlParams = SchemaType<"WorkflowExecutionControlParams">;
export type WorkflowExecutionActionResult = SchemaType<"WorkflowExecutionActionResult">;
export type WorkflowResumeParams = SchemaType<"WorkflowResumeParams">;
...
export type PluginsListParams = SchemaType<"PluginsListParams">;
export type PluginsEnableParams = SchemaType<"PluginsEnableParams">;
export type PluginsDisableParams = SchemaType<"PluginsDisableParams">;
export type PluginsInstallParams = SchemaType<"PluginsInstallParams">;
