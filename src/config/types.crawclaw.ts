...
export type CrawClawConfig = {
  meta?: {
    /** Last CrawClaw version that wrote this config. */
...
declare const crawClawConfigStateBrand: unique symbol;

type BrandedConfigState<TState extends string> = CrawClawConfig & {
  readonly [crawClawConfigStateBrand]?: TState;
};
