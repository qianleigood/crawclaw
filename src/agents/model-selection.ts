...
function resolveAllowedFallbacks(params: { cfg: CrawClawConfig; agentId?: string }): string[] {
  if (params.agentId) {
...
export function buildConfiguredModelCatalog(params: { cfg: CrawClawConfig }): ModelCatalogEntry[] {
