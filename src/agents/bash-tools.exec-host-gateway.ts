...
export async function processGatewayAllowlist(
  ...
  if (requiresAsk) {
    ...
    const guardUnavailable = resolveExecApprovalGuardUnavailable({
      runId: params.runId,
      agentId: params.agentId,
    ...
    if (guardUnavailable) {
      ...
      return {
        pendingResult: buildExecApprovalUnavailableToolResult({
          host: "gateway",
          command: params.command,
          cwd: params.workdir,
          warningText: mergeExecApprovalWarningText(
            initialWarningText,
