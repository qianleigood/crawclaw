...
export const imessageDmPolicy = createTopLevelChannelDmPolicy({
  ...
  getCurrent: (cfg: CrawClawConfig) => cfg.channels?.imessage?.dmPolicy ?? "pairing",
  promptAllowFrom: promptIMessageAllowFrom,
});

function resolveIMessageCliPath(params: { cfg: CrawClawConfig; accountId: string }) {
...
export const imessageCompletionNote = {
  ...
  lines: [
    ...
    "Ensure CrawClaw has Full Disk Access to Messages DB.",
