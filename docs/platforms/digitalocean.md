---
summary: "CrawClaw on DigitalOcean (simple paid VPS option)"
read_when:
  - Setting up CrawClaw on DigitalOcean
  - Looking for cheap VPS hosting for CrawClaw
title: "DigitalOcean (Platform)"
---

# CrawClaw on DigitalOcean

## Goal

Run a persistent CrawClaw Gateway on DigitalOcean for **$6/month** (or $4/mo with reserved pricing).
...
- `~/.crawclaw/workspace/` — workspace (SOUL.md, memory, etc.)
