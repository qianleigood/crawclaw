...
pub(super) const RUST_CORE_TOOL_DEFINITIONS: &[RustCoreToolDefinition] = &[
    ...
    special_agent_tool(
        ...
        "knowledge_model_list",
        "List mental models in Hindsight bank",
        "memory",
        true,
    ),
    special_agent_tool(
        ...
        "knowledge_model_create",
        "Create a new mental model in Hindsight bank",
        "memory",
        false,
    ),
    special_agent_tool(
    ...
    core_tool(
        "ExitWorktree",
        "ExitWorktree",
        "Exit a worktree session and restore original cwd",
        "runtime",
        PROFILE_CODING_FULL,
        false,
        true,
    ...
    core_tool(
        "RemoteTrigger",
        "RemoteTrigger",
        "Manage remote triggers for scheduled execution",
        "automation",
        PROFILE_FULL,
        false,
        true,
