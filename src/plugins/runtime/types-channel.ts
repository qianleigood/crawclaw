/**
 * Legacy TypeScript channel runtime shape.
 *
 * The runtime implementation now throws because channel plugins are moving to
 * Rust-native adapters. The type remains temporarily so non-channel plugin
 * code that references `api.runtime.channel` can still compile during cleanup.
 */
