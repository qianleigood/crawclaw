...
summary: Machine-checked security models for CrawClaw’s highest-risk paths.
read_when:
...
This page tracks CrawClaw’s **formal security models** (TLA+/TLC today; more as needed).

> Note: some older links may refer to the previous project name.

**Goal (north star):** provide a machine-checked argument that CrawClaw enforces its
...
Models are maintained in a separate repo: [vignesh07/crawclaw-formal-models](https://github.com/vignesh07/crawclaw-formal-models).
