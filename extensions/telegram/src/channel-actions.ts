...
} from "crawclaw/plugin-sdk/channel-actions";
...
import type { TelegramActionConfig } from "crawclaw/plugin-sdk/config-runtime";
import { extractToolSend } from "crawclaw/plugin-sdk/tool-send";
import {
...
let telegramActionRuntimePromise: Promise<typeof import("./action-runtime.runtime.js")> | null =
  null;

async function loadTelegramActionRuntime() {
  telegramActionRuntimePromise ??= import("./action-runtime.runtime.js");
