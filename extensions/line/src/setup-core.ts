import type { ChannelSetupAdapter, CrawClawConfig } from "crawclaw/plugin-sdk/setup";
import { createSetupInputPresenceValidator } from "crawclaw/plugin-sdk/setup";
...
export function isLineConfigured(cfg: CrawClawConfig, accountId: string): boolean {
