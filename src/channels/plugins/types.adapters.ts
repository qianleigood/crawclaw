...
export type ChannelConfigAdapter<ResolvedAccount> = {
  ...
  resolveAccount: (cfg: CrawClawConfig, accountId?: string | null) => ResolvedAccount;
  inspectAccount?: (cfg: CrawClawConfig, accountId?: string | null) => unknown;
  defaultAccountId?: (cfg: CrawClawConfig) => string;
  ...
  isEnabled?: (account: ResolvedAccount, cfg: CrawClawConfig) => boolean;
  disabledReason?: (account: ResolvedAccount, cfg: CrawClawConfig) => string;
  isConfigured?: (account: ResolvedAccount, cfg: CrawClawConfig) => boolean | Promise<boolean>;
  unconfiguredReason?: (account: ResolvedAccount, cfg: CrawClawConfig) => string;
  describeAccount?: (account: ResolvedAccount, cfg: CrawClawConfig) => ChannelAccountSnapshot;
...
export type ChannelGatewayContext<ResolvedAccount = unknown> = {
   ...
   * @see {@link https://docs.crawclaw.ai/plugins/developing-plugins | Plugin SDK documentation}
   */
...
export type ChannelLifecycleAdapter = {
  onAccountConfigChanged?: (params: {
    prevCfg: CrawClawConfig;
    nextCfg: CrawClawConfig;
    accountId: string;
    runtime: RuntimeEnv;
  }) => Promise<void> | void;
...
export type ChannelApprovalDeliveryAdapter = {
  hasConfiguredDmRoute?: (params: { cfg: CrawClawConfig }) => boolean;
...
export type ChannelAllowlistAdapter = {
  applyConfigEdit?: (params: {
    ...
    | Promise<
      ...
      >
    | null;
  readConfig?: (params: { cfg: CrawClawConfig; accountId?: string | null }) =>
    | {
...
export type ChannelConversationBindingSupport = {
  ...
  createManager?: (params: { cfg: CrawClawConfig; accountId?: string | null }) =>
    | {
