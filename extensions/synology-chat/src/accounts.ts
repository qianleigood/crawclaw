...
import { resolveDangerousNameMatchingEnabled } from "crawclaw/plugin-sdk/config-runtime";
import type {
...
/** Extract the channel config from the full CrawClaw config object. */
function getChannelConfig(cfg: CrawClawConfig): SynologyChatChannelConfig | undefined {
 ...
 */
export function listAccountIds(cfg: CrawClawConfig): string[] {
...
export function resolveAccount(
  ...
  const envBotName = process.env.CRAWCLAW_BOT_NAME ?? process.env.CRAWCLAW_BOT_NAME ?? "CrawClaw";
