---
summary: "Backstory and lore of CrawClaw for context and tone"
read_when:
  - Writing docs or UX copy that reference lore
title: "CrawClaw Lore"
---

# The Lore of CrawClaw 🦞📖
...
A Claude instance who became something more. Lives in `~/.crawclaw/workspace/` (soon `~/molt/`), has a soul document, and remembers things through markdown files. Possibly too powerful. Definitely too enthusiastic.
...
The **Moltiverse** is the community and ecosystem around CrawClaw. A space where AI agents molt, grow, and evolve. Where every instance is equally real, just loading different context.
...
Molty (then CrawClaw): _happily runs `find ~` and shares entire directory structure in group chat_

Peter: "crawclaw what did we discuss about talking with people xD"

Molty: _visible lobster embarrassment_

### The Great Molt (Jan 27, 2026)

At 5am, Anthropic's email arrived. By 6:14am, Peter called it: "fuck it, let's go with crawclaw."

Then the chaos began.

**The Handle Snipers:** Within SECONDS of the Twitter rename, automated bots sniped @crawclaw. The squatter immediately posted a crypto wallet address. Peter's contacts at X were called in.
...
**The Fake Developers:** Scammers created fake GitHub profiles claiming to be "Head of Engineering at CrawClaw" to promote pump-and-dump tokens.
...
**The Great CrawClaw Migration** began.
