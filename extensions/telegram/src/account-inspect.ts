import { resolveAccountWithDefaultFallback } from "crawclaw/plugin-sdk/account-core";
import type { CrawClawConfig } from "crawclaw/plugin-sdk/config-runtime";
import { coerceSecretRef } from "crawclaw/plugin-sdk/config-runtime";
import { tryReadSecretFileSync } from "crawclaw/plugin-sdk/core";
import { resolveDefaultSecretProviderAlias } from "crawclaw/plugin-sdk/provider-auth";
import { DEFAULT_ACCOUNT_ID, normalizeAccountId } from "crawclaw/plugin-sdk/routing";
import {
  hasConfiguredSecretInput,
  normalizeSecretInputString,
} from "crawclaw/plugin-sdk/secret-input";
import type { TelegramAccountConfig } from "crawclaw/plugin-sdk/telegram-core";
import {
...
function inspectTokenValue(params: { cfg: CrawClawConfig; value: unknown }): {
  token: string;
