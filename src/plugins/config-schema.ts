...
import type { PluginConfigUiHint, CrawClawPluginConfigSchema } from "./types.js";
...
type BuildPluginConfigSchemaOptions = {
  ...
  safeParse?: CrawClawPluginConfigSchema["safeParse"];
};
...
export function emptyPluginConfigSchema(): CrawClawPluginConfigSchema {
  return {
