...
const { resolveAgentRunSkillEntries } = await import("./skills-runtime.js");

describe("resolveAgentRunSkillEntries", () => {
  ...
  it("loads skill entries with current config", () => {
    ...
    const result = resolveAgentRunSkillEntries({
