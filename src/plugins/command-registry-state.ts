...
import type { CrawClawPluginCommandDefinition } from "./types.js";

export type RegisteredPluginCommand = CrawClawPluginCommandDefinition & {
  pluginId: string;
  pluginName?: string;
  pluginRoot?: string;
};
...
const PLUGIN_COMMAND_STATE_KEY = Symbol.for("crawclaw.pluginCommandsState");
