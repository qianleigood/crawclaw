...
If you want the lowest-friction local setup, start with [Ollama](/providers/ollama) and `crawclaw onboard`. This page is the opinionated guide for higher-end local stacks and custom OpenAI-compatible local servers.
