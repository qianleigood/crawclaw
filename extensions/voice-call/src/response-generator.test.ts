...
function createAgentRuntime(payloads: Array<Record<string, unknown>>) {
  ...
  const runtime = {
    ...
    resolveAgentDir: () => "/tmp/crawclaw/agents/main",
    resolveAgentWorkspaceDir: () => "/tmp/crawclaw/workspace/main",
    ...
    session: {
      ...
      resolveSessionFilePath: () => "/tmp/crawclaw/sessions/session.jsonl",
    },
