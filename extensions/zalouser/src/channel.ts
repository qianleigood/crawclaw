import { createScopedDmSecurityResolver } from "crawclaw/plugin-sdk/channel-config-helpers";
import { createAccountStatusSink } from "crawclaw/plugin-sdk/channel-lifecycle";
import { createPairingPrefixStripper } from "crawclaw/plugin-sdk/channel-pairing";
import {
  createEmptyChannelResult,
  createRawChannelSendResultAdapter,
} from "crawclaw/plugin-sdk/channel-send-result";
import { createStaticReplyToModeResolver } from "crawclaw/plugin-sdk/conversation-runtime";
import { createChatChannelPlugin } from "crawclaw/plugin-sdk/core";
import { buildPassiveProbedChannelStatusSummary } from "crawclaw/plugin-sdk/extension-shared";
import {
...
function resolveZalouserOutboundChunkMode(cfg: CrawClawConfig, accountId?: string) {
  return getZalouserRuntime().channel.text.resolveChunkMode(cfg, "zalouser", accountId);
}

function resolveZalouserOutboundTextChunkLimit(cfg: CrawClawConfig, accountId?: string) {
