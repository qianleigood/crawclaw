---
summary: "Run CrawClaw Gateway 24/7 on a cheap Hetzner VPS (Docker) with durable state and baked-in binaries"
read_when:
  - You want CrawClaw running 24/7 on a cloud VPS (not your laptop)
  - You want a production-grade, always-on Gateway on your own VPS
  - You want full control over persistence, binaries, and restart behavior
  - You are running CrawClaw in Docker on Hetzner or a similar provider
title: "Hetzner"
---

# CrawClaw on Hetzner (Docker, Production VPS Guide)

## Goal

Run a persistent CrawClaw Gateway on a Hetzner VPS using Docker, with durable state, baked-in binaries, and safe restart behavior.

If you want “CrawClaw 24/7 for ~$5”, this is the simplest reliable setup.
...
- Infrastructure: [crawclaw-terraform-hetzner](https://github.com/andreesg/crawclaw-terraform-hetzner)
- Docker config: [crawclaw-docker-config](https://github.com/andreesg/crawclaw-docker-config)
