...
import { resolveAgentMaxConcurrent } from "crawclaw/plugin-sdk/config-runtime";
...
import { waitForAbortSignal } from "crawclaw/plugin-sdk/runtime-env";
...
export function createTelegramRunnerOptions(cfg: CrawClawConfig): RunOptions<unknown> {
  return {
    sink: {
