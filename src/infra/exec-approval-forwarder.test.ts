...
function makeTargetsCfg(targets: Array<{ channel: string; to: string }>): CrawClawConfig {
  return {
    approvals: {
      exec: {
        enabled: true,
...
function makeSessionCfg(options: { discordExecApprovalsEnabled?: boolean } = {}): CrawClawConfig {
  return {
