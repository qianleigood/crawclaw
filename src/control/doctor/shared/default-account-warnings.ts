...
export function collectMissingDefaultAccountBindingWarnings(cfg: CrawClawConfig): string[] {
...
export function collectMissingExplicitDefaultAccountWarnings(cfg: CrawClawConfig): string[] {
  const warnings: string[] = [];
