export const INTERNAL_RUNTIME_CONTEXT_BEGIN = "<<<BEGIN_CRAWCLAW_INTERNAL_CONTEXT>>>";
export const INTERNAL_RUNTIME_CONTEXT_END = "<<<END_CRAWCLAW_INTERNAL_CONTEXT>>>";

const ESCAPED_INTERNAL_RUNTIME_CONTEXT_BEGIN = "[[CRAWCLAW_INTERNAL_CONTEXT_BEGIN]]";
const ESCAPED_INTERNAL_RUNTIME_CONTEXT_END = "[[CRAWCLAW_INTERNAL_CONTEXT_END]]";
