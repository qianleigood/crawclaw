...
6. **Memory / Experience** — asks whether to enable NotebookLM-backed experience recall. If enabled and the provider recommends `crawclaw memory login`, onboarding can offer to run that login flow near the end.
