...
function enableSlackAccount(cfg: CrawClawConfig, accountId: string): CrawClawConfig {
...
function hasSlackInteractiveRepliesConfig(cfg: CrawClawConfig, accountId: string): boolean {
...
function createSlackTokenCredential(params: {
  ...
  return {
    ...
    applyUseEnv: ({ cfg, accountId }: { cfg: CrawClawConfig; accountId: string }) =>
