...
// Streaming card mode: enabled by default. Card replies use Feishu's Card Kit
// streaming API for incremental text display with a "Thinking..." placeholder.
// Runtime reply policy may still fall back to non-streaming delivery for
// thread/topic replies and raw text render mode.
