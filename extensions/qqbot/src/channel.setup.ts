...
import type { ChannelSetupInput } from "crawclaw/plugin-sdk/setup";
...
/**
 * Setup-only QQBot plugin — lightweight subset used during `crawclaw onboard`
 * and `crawclaw configure` without pulling the full runtime dependencies.
 */
