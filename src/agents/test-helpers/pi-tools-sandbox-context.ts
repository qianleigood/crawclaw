...
export function createPiToolsSandboxContext(params: PiToolsSandboxContextParams): SandboxContext {
  ...
  return {
    ...
    runtimeId: params.containerName ?? "crawclaw-sbx-test",
    runtimeLabel: params.containerName ?? "crawclaw-sbx-test",
    containerName: params.containerName ?? "crawclaw-sbx-test",
