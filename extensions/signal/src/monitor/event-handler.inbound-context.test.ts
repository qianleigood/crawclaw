...
let expectInboundContextContract: typeof import("crawclaw/plugin-sdk/testing").expectChannelInboundContextContract;
...
describe("signal createSignalEventHandler inbound context", () => {
  beforeAll(async () => {
    ...
    ({ expectChannelInboundContextContract: expectInboundContextContract } =
      await import("crawclaw/plugin-sdk/testing"));
