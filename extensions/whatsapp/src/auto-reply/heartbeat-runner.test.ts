import { redactIdentifier } from "crawclaw/plugin-sdk/logging-core";
import type { getReplyFromConfig } from "crawclaw/plugin-sdk/reply-runtime";
import { HEARTBEAT_TOKEN } from "crawclaw/plugin-sdk/reply-runtime";
...
vi.mock("crawclaw/plugin-sdk/agent-runtime", () => ({
...
vi.mock("crawclaw/plugin-sdk/routing", async (importOriginal) => {
  const actual = await importOriginal<typeof import("crawclaw/plugin-sdk/routing")>();
  return {
    ...actual,
...
vi.mock("../auth-store.js", () => ({
  WA_WEB_AUTH_DIR: "/tmp/crawclaw-oauth/whatsapp/default",
  resolveDefaultWebAuthDir: () => "/tmp/crawclaw-oauth/whatsapp/default",
