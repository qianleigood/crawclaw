...
import { getImageMetadata } from "crawclaw/plugin-sdk/media-runtime";
import { isGifMedia, kindFromMime } from "crawclaw/plugin-sdk/media-runtime";
import { normalizePollInput, type PollInput } from "crawclaw/plugin-sdk/media-runtime";
import { createTelegramRetryRunner, type RetryConfig } from "crawclaw/plugin-sdk/retry-runtime";
...
type TelegramSendOpts = {
  ...
  asVoice?: boolean;
  /** Send video note instead of regular video. Defaults to false. */
  asVideoNote?: boolean;
