    ...
    <section class="control-console-stage control-console-stage--usage">
      ...
      <div class="usage-console-grid">
        <aside class="usage-console-grid__rail">
          <section class="card usage-rail-summary">
            <div class="usage-rail-summary__header">
              <div class="card-title">${uiLiteral("Observability rail")}</div>
              <div class="card-sub">${t("usage.page.subtitle")}</div>
            </div>
            <div class="usage-rail-summary__stats">
              <div class="usage-rail-summary__stat">
                <span class="usage-rail-summary__label">${t("usage.metrics.tokens")}</span>
                <strong class="usage-rail-summary__value"
                  >${displayTotals ? formatTokens(displayTotals.totalTokens) : "0"}</strong
                >
              </div>
              <div class="usage-rail-summary__stat">
                <span class="usage-rail-summary__label">${t("usage.metrics.cost")}</span>
                <strong class="usage-rail-summary__value"
                  >${displayTotals ? formatCost(displayTotals.totalCost) : "$0.00"}</strong
                >
              </div>
              <div class="usage-rail-summary__stat">
                <span class="usage-rail-summary__label">${uiLiteral("Sessions")}</span>
                <strong class="usage-rail-summary__value">${displaySessionCount}</strong>
              </div>
              <div class="usage-rail-summary__stat">
                <span class="usage-rail-summary__label">${uiLiteral("Selected days")}</span>
                <strong class="usage-rail-summary__value">${filters.selectedDays.length}</strong>
              </div>
              <div class="usage-rail-summary__stat">
                <span class="usage-rail-summary__label">${uiLiteral("Query terms")}</span>
                <strong class="usage-rail-summary__value">${queryTermCount}</strong>
              </div>
            </div>
          </section>

          <section class="control-context-strip usage-console-grid__context">
        ...
        <div class="usage-console-grid__main">
              ...
              <div class="usage-header-row">
                ...
                <div class="usage-header-metrics">
                  ...
                  <button
                    ...
                    title=${display.headerPinned
                      ? t("usage.filters.unpin")
                      : t("usage.filters.pin")}
