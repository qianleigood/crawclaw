...
import { SYNTHETIC_DEFAULT_MODEL_REF as SYNTHETIC_DEFAULT_MODEL_REF_PUBLIC } from "crawclaw/plugin-sdk/synthetic";
...
describe("synthetic onboard", () => {
  ...
  it("merges existing synthetic provider models", () => {
    ...
    const ids = cfg.models?.providers?.synthetic?.models.map((m: { id: string }) => m.id);
