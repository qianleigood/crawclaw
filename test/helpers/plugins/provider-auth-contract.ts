...
type LoginOpenAICodexOAuth =
  (typeof import("crawclaw/plugin-sdk/provider-auth-login"))["loginOpenAICodexOAuth"];
type GithubCopilotLoginCommand =
  (typeof import("crawclaw/plugin-sdk/provider-auth-login"))["githubCopilotLoginCommand"];
...
type EnsureAuthProfileStore =
  typeof import("crawclaw/plugin-sdk/provider-auth").ensureAuthProfileStore;
type ListProfilesForProvider =
  typeof import("crawclaw/plugin-sdk/provider-auth").listProfilesForProvider;
...
vi.mock("crawclaw/plugin-sdk/provider-auth-login", async (importOriginal) => {
  const actual = await importOriginal<typeof import("crawclaw/plugin-sdk/provider-auth-login")>();
  return {
    ...actual,
...
vi.mock("crawclaw/plugin-sdk/provider-auth", async (importOriginal) => {
  const actual = await importOriginal<typeof import("crawclaw/plugin-sdk/provider-auth")>();
  return {
    ...actual,
