...
function isConfiguredAuthPlugin(plugin: ChannelPlugin, cfg: CrawClawConfig): boolean {
  const key = plugin.id;
...
function resolveConfiguredAuthChannelInput(cfg: CrawClawConfig, mode: ChannelAuthMode): string {
