...
import { resolveBundledInstallPlanForCatalogEntry } from "../../terminal/plugin-install-plan.js";
...
function addPluginLoadPath(cfg: CrawClawConfig, pluginPath: string): CrawClawConfig {
