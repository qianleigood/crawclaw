...
type XaiPluginConfig = NonNullable<
  NonNullable<CrawClawConfig["plugins"]>["entries"]
>["xai"] extends {
  config?: infer Config;
}
  ? Config
...
function readPluginCodeExecutionConfig(cfg?: CrawClawConfig): CodeExecutionConfig | undefined {
    ...
    execute: async (_toolCallId: string, args: Record<string, unknown>) => {
      ...
      if (!apiKey) {
        return jsonResult({
          ...
          docs: "https://docs.crawclaw.ai/tools/code-execution",
        });
      }
