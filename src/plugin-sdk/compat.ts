...
const shouldWarnCompatImport =
  ...
  process.env.CRAWCLAW_SUPPRESS_PLUGIN_SDK_COMPAT_WARNING !== "1";

if (shouldWarnCompatImport) {
  process.emitWarning(
    "crawclaw/plugin-sdk/compat is deprecated for new plugins. Migrate to focused crawclaw/plugin-sdk/<subpath> imports. See https://docs.crawclaw.ai/plugins/sdk-migration",
    {
      code: "CRAWCLAW_PLUGIN_SDK_COMPAT_DEPRECATED",
      detail:
        "Bundled plugins must use scoped plugin-sdk subpaths. External plugins may keep compat temporarily while migrating. Migration guide: https://docs.crawclaw.ai/plugins/sdk-migration",
    },
  );
}
