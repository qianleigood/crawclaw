...
status: historical
x-i18n:
  generated_at: "2026-06-10T12:56:49Z"
  model: codex
  provider: openai
  source_hash: 8741257a22b57e021018407ddf978931fe870a79380f31b5610ffadc58ec867d
  source_path: debug/memory-architecture-redesign.md
  workflow: 15
---

# 记忆架构重设计：Hindsight 原生

> 历史说明：本文记录迁移前的设计基线和拟议 rollout。当前运行时不再暴露下文部分章节提到的旧本地 outbox 或 file-backed durable-memory tool surface。
