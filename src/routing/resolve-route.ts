...
export type ResolveAgentRouteInput = {
  ...
  guildId?: string | null;
  teamId?: string | null;
  /** Channel member role IDs, when the provider exposes role-based routing metadata. */
...
function listAgents(cfg: CrawClawConfig) {
...
export function pickFirstExistingAgentId(cfg: CrawClawConfig, agentId: string): string {
...
const evaluatedBindingsCacheByCfg = new WeakMap<CrawClawConfig, EvaluatedBindingsCache>();
