---
summary: "Use OpenCode Zen and Go catalogs with CrawClaw"
read_when:
...
OpenCode exposes two hosted catalogs in CrawClaw:

- `opencode/...` for the **Zen** catalog
- `opencode-go/...` for the **Go** catalog

Both catalogs use the same OpenCode API key. CrawClaw keeps the runtime provider ids
