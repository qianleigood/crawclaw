import type { KilocodeModelCatalogEntry } from "crawclaw/plugin-sdk/provider-model-shared";
import type { ModelDefinitionConfig } from "crawclaw/plugin-sdk/provider-model-shared";
