import { definePluginEntry, type ProviderAuthContext } from "crawclaw/plugin-sdk/plugin-entry";
import {
  coerceSecretRef,
  ensureAuthProfileStore,
  listProfilesForProvider,
} from "crawclaw/plugin-sdk/provider-auth";
import { githubCopilotLoginCommand } from "crawclaw/plugin-sdk/provider-auth-login";
