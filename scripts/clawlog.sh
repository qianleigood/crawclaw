...
show_usage() {
    cat << EOF
clawlog - CrawClaw Logging Utility

USAGE:
    clawlog [OPTIONS]

DESCRIPTION:
    View CrawClaw logs with full details (bypasses Apple's privacy redaction).
    Requires sudo access configured for /usr/bin/log command.

LOG FLOW ARCHITECTURE:
    CrawClaw logs flow through the macOS unified log (subsystem: ai.crawclaw).
