...
import { replaceConfigFile, type CrawClawConfig } from "../../config/config.js";
...
export async function channelsAddCommand(
  ...
  const cfg = (configSnapshot.sourceConfig ?? configSnapshot.config) as CrawClawConfig;
  ...
  // May trigger loadCrawClawPlugins on cache miss (disk scan + jiti import)
