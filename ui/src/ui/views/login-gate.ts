    ...
    <div class="login-gate">
      <div class="login-gate__card">
        <div class="login-gate__header">
          ${state.onboarding
            ? html`<div class="login-gate__eyebrow">${t("login.onboarding.eyebrow")}</div>`
            : html``}
          <img class="login-gate__logo" src=${faviconSrc} alt="CrawClaw" />
          <div class="login-gate__title">CrawClaw</div>
          ...
          <label class="field">
            ...
            <div class="login-gate__secret-row">
              <input
                ...
                placeholder="CRAWCLAW_GATEWAY_TOKEN (${t("login.passwordPlaceholder")})"
          ...
          <label class="field">
            ...
            <div class="login-gate__secret-row">
              ...
              <button
                ...
                title=${state.loginShowGatewayPassword ? t("login.hidePassword") : t("login.showPassword")}
        ...
        <div class="login-gate__help">
          ...
          <ol class="login-gate__steps">
            <li>
              ${t("overview.connection.step1")}${renderConnectCommand("crawclaw gateway run")}
            </li>
            <li>${t("overview.connection.step2")} ${renderConnectCommand("crawclaw dashboard")}</li>
            <li>${t("overview.connection.step3")}</li>
          </ol>
          ${state.onboarding
            ? html`
                <div class="callout info" style="margin-top: 14px;">
                  ${t("login.onboarding.nextSteps")}
                </div>
              `
            : html``}
