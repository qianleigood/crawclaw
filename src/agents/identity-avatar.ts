...
function resolveAvatarSource(cfg: CrawClawConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: CrawClawConfig, agentId: string): AgentAvatarResolution {
