---
title: "Showcase"
summary: "Community-built projects and integrations powered by CrawClaw"
read_when:
  - Looking for real CrawClaw usage examples
...
<Info>
**Want to be featured?** Share your project in [Discord](https://discord.gg/qkhbAGHRBT) or [tag @crawclaw on X](https://x.com/crawclaw).
</Info>
...
Asked “Robby” (@crawclaw) for a local wine cellar skill. It requests a sample CSV export + where to store it, then builds/tests the skill fast (962 bottles in the example).
...
CLI for Linear that integrates with agentic workflows (Claude Code, CrawClaw). Manage issues, projects, and workflows from the terminal. First external PR merged!
</Card>
...
Claude Code discovered and confirmed the purifier controls, then CrawClaw takes over to manage room air quality.
...
<Card title="xuezh Chinese Learning" icon="language" href="https://github.com/joshp123/xuezh">
  **@joshp123** • `learning` `voice` `skill`
  ...
  Chinese learning engine with pronunciation feedback and study flows via CrawClaw.
...
<Card title="Clawdia Phone Bridge" icon="phone" href="https://github.com/alejandroOPI/clawdia-bridge">
  **@alejandroOPI** • `voice` `vapi` `bridge`
  ...
  Vapi voice assistant ↔ CrawClaw HTTP bridge. Near real-time phone calls with your agent.
</Card>
...
<Card title="Home Assistant Add-on" icon="home" href="https://github.com/ngutman/crawclaw-ha-addon">
  **@ngutman** • `homeassistant` `raspberry-pi`
  
  CrawClaw gateway running on Home Assistant OS with SSH tunnel support and persistent state.
</Card>
...
<Card title="Nix Packaging" icon="snowflake" href="https://github.com/crawclaw/nix-crawclaw">
  **@crawclaw** • `nix` `packaging` `deployment`
  
  Batteries-included nixified CrawClaw configuration for reproducible deployments.
</Card>
...
<Card title="StarSwap Marketplace" icon="star" href="https://star-swap.com/">
  **Community** • `marketplace` `astronomy` `webapp`
  ...
  Full astronomy gear marketplace. Built with/around the CrawClaw ecosystem.
</Card>
...
<Steps>
  <Step title="Share It">
    Post in [Discord](https://discord.gg/qkhbAGHRBT) or [tweet @crawclaw](https://x.com/crawclaw)
  </Step>
