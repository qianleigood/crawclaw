...
function resolveDefaultAccountId(cfg: CrawClawConfig, provider: ChannelId): string {
...
function shouldShowProviderEntry(entry: ProviderAccountStatus, cfg: CrawClawConfig): boolean {
...
export function summarizeBindings(cfg: CrawClawConfig, bindings: AgentBinding[]): string[] {
