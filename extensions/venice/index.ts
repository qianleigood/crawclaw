...
import { applyModelCompatPatch } from "crawclaw/plugin-sdk/provider-model-shared";
import type { ModelCompatConfig } from "crawclaw/plugin-sdk/provider-model-shared";
import { XAI_UNSUPPORTED_SCHEMA_KEYWORDS } from "crawclaw/plugin-sdk/provider-tools";
