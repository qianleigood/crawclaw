...
import type { resolveAgentRoute } from "crawclaw/plugin-sdk/routing";
...
export type LoadedConfig = ReturnType<
  typeof import("crawclaw/plugin-sdk/config-runtime").loadConfig
>;
export type RuntimeEnv = import("crawclaw/plugin-sdk/runtime-env").RuntimeEnv;
...
type DiscordMessagePreflightSharedFields = {
  ...
  discordConfig: NonNullable<
    import("crawclaw/plugin-sdk/config-runtime").CrawClawConfig["channels"]
  >["discord"];
  accountId: string;
  token: string;
  runtime: RuntimeEnv;
