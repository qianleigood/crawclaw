...
import { mediaKindFromMime } from "crawclaw/plugin-sdk/media-runtime";
import { withTempDownloadPath, type CrawClawConfig } from "../runtime-api.js";
...
function createConfiguredFeishuMediaClient(params: { cfg: CrawClawConfig; accountId?: string }): {
...
export async function downloadImageFeishu(params: {
  ...
  const buffer = await readFeishuResponseBuffer({
    response,
    tmpDirPrefix: "crawclaw-feishu-img-",
...
export async function downloadMessageResourceFeishu(params: {
  ...
  const buffer = await readFeishuResponseBuffer({
    response,
    tmpDirPrefix: "crawclaw-feishu-resource-",
