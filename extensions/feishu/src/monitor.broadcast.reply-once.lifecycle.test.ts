...
import {
  cleanupFeishuLifecycleTestState,
...
function createLifecycleConfig(): CrawClawConfig {
  return {
    broadcast: {
...
describe("Feishu broadcast reply-once lifecycle", () => {
  beforeEach(() => {
    ...
    setFeishuLifecycleStateDir("crawclaw-feishu-broadcast");
  ...
  afterEach(() => {
    cleanupFeishuLifecycleTestState(originalStateDir);
  });
