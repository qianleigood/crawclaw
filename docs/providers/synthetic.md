---
summary: "Use Synthetic's Anthropic-compatible API in CrawClaw"
read_when:
...
Synthetic exposes Anthropic-compatible endpoints. CrawClaw registers it as the
...
Note: CrawClaw's Anthropic client appends `/v1` to the base URL, so use
