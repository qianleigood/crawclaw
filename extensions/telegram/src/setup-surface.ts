...
function shouldShowTelegramDmAccessWarning(cfg: CrawClawConfig, accountId: string): boolean {
...
function buildTelegramDmAccessWarningLines(accountId: string): string[] {
  ...
  return [
    ...
    "  " + formatCliCommand(`crawclaw config set ${configBase}.dmPolicy "allowlist"`),
    "  " + formatCliCommand(`crawclaw config set ${configBase}.allowFrom '["YOUR_USER_ID"]'`),
