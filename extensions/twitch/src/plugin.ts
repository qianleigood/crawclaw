/**
 * Twitch channel plugin for CrawClaw.
 *
...
} from "crawclaw/plugin-sdk/channel-pairing";
...
import type { CrawClawConfig } from "../api.js";
 ...
 * for CrawClaw. Supports message sending, receiving, access control, and
 * status monitoring.
 */
export const twitchPlugin: ChannelPlugin<ResolvedTwitchAccount> =
  createChatChannelPlugin<ResolvedTwitchAccount>({
    ...
    base: {
      ...
      config: {
        listAccountIds: (cfg: CrawClawConfig): string[] => listAccountIds(cfg),
        resolveAccount: (cfg: CrawClawConfig, accountId?: string | null): ResolvedTwitchAccount => {
        ...
        isConfigured: (_account: unknown, cfg: CrawClawConfig): boolean =>
      ...
      resolver: {
        resolveTargets: async ({
          ...
          runtime: import("crawclaw/plugin-sdk/runtime-env").RuntimeEnv;
