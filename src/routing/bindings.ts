...
export function listBindings(cfg: CrawClawConfig): AgentRouteBinding[] {
...
export function listBoundAccountIds(cfg: CrawClawConfig, channelId: string): string[] {
...
export function buildChannelAccountBindings(cfg: CrawClawConfig) {
