...
export function createAccountListHelpers(
  ...
  function resolveConfiguredDefaultAccountId(cfg: CrawClawConfig): string | undefined {
  ...
  function listAccountIds(cfg: CrawClawConfig): string[] {
  ...
  function resolveDefaultAccountId(cfg: CrawClawConfig): string {
