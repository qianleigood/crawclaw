...
- Install via CLI: `crawclaw plugins install @crawclaw/zalo`
...
1. Install the Zalo plugin:
   - From a source checkout: `crawclaw plugins install ./path/to/local/zalo-plugin`
   - From npm (if published): `crawclaw plugins install @crawclaw/zalo`
...
This page reflects current CrawClaw behavior for **Zalo Bot Creator / Marketplace bots**.
...
- Approve via:
  - `crawclaw pairing list zalo`
  - `crawclaw pairing approve zalo <CODE>`
...
This table summarizes current **Zalo Bot Creator / Marketplace bot** behavior in CrawClaw.
...
- Example: `crawclaw message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `crawclaw channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `crawclaw logs --follow`
