...
const FEISHU_STARTUP_BOT_INFO_TIMEOUT_ENV = "CRAWCLAW_FEISHU_STARTUP_PROBE_TIMEOUT_MS";
const FEISHU_STARTUP_BOT_INFO_TIMEOUT_ENV_FALLBACK = "CRAWCLAW_FEISHU_STARTUP_PROBE_TIMEOUT_MS";

function resolveStartupProbeTimeoutMs(): number {
  const raw =
    process.env[FEISHU_STARTUP_BOT_INFO_TIMEOUT_ENV] ??
    process.env[FEISHU_STARTUP_BOT_INFO_TIMEOUT_ENV_FALLBACK];
  if (raw) {
