...
function buildConfig(
  execApprovals?: NonNullable<NonNullable<CrawClawConfig["channels"]>["matrix"]>["execApprovals"],
  channelOverrides?: Partial<NonNullable<NonNullable<CrawClawConfig["channels"]>["matrix"]>>,
): CrawClawConfig {
  return {
    channels: {
      matrix: {
