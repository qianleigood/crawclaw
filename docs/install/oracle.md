---
summary: "Host CrawClaw on Oracle Cloud's Always Free ARM tier"
read_when:
  - Setting up CrawClaw on Oracle Cloud
  - Looking for free VPS hosting for CrawClaw
...
Run a persistent CrawClaw Gateway on Oracle Cloud's **Always Free** ARM tier (up to 4 OCPU, 24 GB RAM, 200 GB storage) at no cost.
...
<Steps>
  ...
  <Step title="Install Tailscale">
    ...
    From now on, connect via Tailscale: `ssh ubuntu@crawclaw`.
