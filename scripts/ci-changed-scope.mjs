...
const NODE_SCOPE_RE =
  /^(src\/|extensions\/|packages\/|scripts\/|\.github\/|crawclaw\.mjs$|package\.json$|pnpm-lock\.yaml$|pnpm-workspace\.yaml$|tsconfig.*\.json$|\.oxlintrc\.json$|\.oxfmtrc\.jsonc$)/;
const WINDOWS_SCOPE_RE =
  /^(src\/|extensions\/|packages\/|scripts\/|crawclaw\.mjs$|package\.json$|pnpm-lock\.yaml$|pnpm-workspace\.yaml$|tsconfig.*\.json$|\.github\/workflows\/ci\.yml$|\.github\/actions\/setup-node-env\/action\.yml$|\.github\/actions\/setup-pnpm-store-cache\/action\.yml$)/;
const CHANGED_SMOKE_SCOPE_RE =
  /^(\.npmrc$|package\.json$|pnpm-lock\.yaml$|pnpm-workspace\.yaml$|scripts\/ci-changed-scope\.mjs$|scripts\/ci-write-manifest-outputs\.mjs$|extensions\/[^/]+\/package\.json$|\.github\/workflows\/ci\.yml$|\.github\/actions\/setup-node-env\/action\.yml$)/;
