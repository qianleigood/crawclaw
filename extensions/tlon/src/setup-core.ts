...
export async function resolveTlonSetupConfigured(cfg: CrawClawConfig): Promise<boolean> {
...
export async function resolveTlonSetupStatusLines(cfg: CrawClawConfig): Promise<string[]> {
