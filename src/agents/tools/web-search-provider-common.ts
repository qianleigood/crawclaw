...
export type SearchConfigRecord = (NonNullable<CrawClawConfig["tools"]>["web"] extends infer Web
...
export function parseIsoDateRange(params: {
  ...
  const docs = params.docs ?? "https://docs.crawclaw.ai/tools/web";
