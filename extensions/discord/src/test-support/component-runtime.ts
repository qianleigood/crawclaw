...
async function createConversationRuntimeMock(
  importOriginal: () => Promise<typeof import("crawclaw/plugin-sdk/conversation-runtime")>,
) {
...
vi.mock("crawclaw/plugin-sdk/security-runtime", (importOriginal) =>
  createAllowFromRuntimeMock(importOriginal),
);

vi.mock("crawclaw/plugin-sdk/conversation-runtime", createConversationRuntimeMock);
vi.mock("crawclaw/plugin-sdk/conversation-runtime.js", createConversationRuntimeMock);
...
export function resetDiscordComponentRuntimeMocks() {
  ...
  resolvePluginConversationBindingApprovalMock.mockReset().mockResolvedValue({
    ...
    binding: {
      ...
      pluginName: "CrawClaw App Server",
