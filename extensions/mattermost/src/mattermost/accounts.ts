import { createAccountListHelpers } from "crawclaw/plugin-sdk/account-helpers";
import { DEFAULT_ACCOUNT_ID, normalizeAccountId } from "crawclaw/plugin-sdk/account-id";
import { resolveMergedAccountConfig } from "crawclaw/plugin-sdk/account-resolution";
...
export function listMattermostAccountIds(cfg: CrawClawConfig): string[] {
  return mattermostAccountHelpers.listAccountIds(cfg);
}

export function resolveDefaultMattermostAccountId(cfg: CrawClawConfig): string {
...
export function listEnabledMattermostAccounts(cfg: CrawClawConfig): ResolvedMattermostAccount[] {
