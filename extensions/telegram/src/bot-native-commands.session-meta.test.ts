...
type ResolveConfiguredBindingRouteFn =
  typeof import("crawclaw/plugin-sdk/conversation-runtime").resolveConfiguredBindingRoute;
type EnsureConfiguredBindingRouteReadyFn =
  typeof import("crawclaw/plugin-sdk/conversation-runtime").ensureConfiguredBindingRouteReady;
...
vi.mock("crawclaw/plugin-sdk/command-auth", async (importOriginal) => {
...
describe("registerTelegramNativeCommands — session metadata", () => {
  ...
  beforeEach(() => {
    ...
    sessionMocks.resolveStorePath.mockClear().mockReturnValue("/tmp/crawclaw-sessions.json");
  ...
  it("preserves the topic-qualified origin target for native /new in forum topics", async () => {
