...
function resolveResolutionLimits(config: CrawClawConfig): ResolutionLimits {
...
function resolveConfiguredProvider(ref: SecretRef, config: CrawClawConfig): SecretProviderConfig {
