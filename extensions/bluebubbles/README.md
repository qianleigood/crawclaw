...
This package contains the **BlueBubbles external channel plugin** for CrawClaw.
...
- Route into core reply pipeline via the plugin runtime (`api.runtime`) and `crawclaw/plugin-sdk` helpers.
