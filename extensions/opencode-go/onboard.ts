...
export function applyOpencodeGoProviderConfig(cfg: CrawClawConfig): CrawClawConfig {
  return {
    ...cfg,
    agents: {
      ...cfg.agents,
...
export function applyOpencodeGoConfig(cfg: CrawClawConfig): CrawClawConfig {
