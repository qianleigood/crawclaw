...
function buildConfig(
  execApprovals?: NonNullable<NonNullable<CrawClawConfig["channels"]>["telegram"]>["execApprovals"],
  channelOverrides?: Partial<NonNullable<NonNullable<CrawClawConfig["channels"]>["telegram"]>>,
): CrawClawConfig {
  return {
    channels: {
      telegram: {
