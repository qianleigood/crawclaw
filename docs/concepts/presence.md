---
summary: "How CrawClaw presence entries are produced, merged, and displayed"
read_when:
...
#### Why one-off Desktop and Gateway API actions do not show up
...
Clients can send richer periodic beacons via the `system-event` method. Desktop
and web clients use this to report host name, IP, and `lastInputSeconds`.
