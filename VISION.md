...
CrawClaw is the AI that actually does things.
...
CrawClaw started as a personal playground to learn AI and build something genuinely useful:
an assistant that can run real tasks on a real computer.
It evolved through several names and shells: Warelay -> Clawdbot -> Moltbot -> CrawClaw.
...
Security in CrawClaw is a deliberate tradeoff: strong defaults without killing capability.
...
CrawClaw has an extensive plugin API.
...
Community plugin listing + PR bar: https://docs.crawclaw.ai/plugins/community
...
CrawClaw supports MCP through `mcporter`: https://github.com/steipete/mcporter
