...
function createSandboxContext(overrides?: Partial<SandboxContext>): SandboxContext {
  const base = {
    ...
    workspaceDir: "/tmp/crawclaw-sandbox",
    agentWorkspaceDir: "/tmp/crawclaw-workspace",
    workspaceAccess: "none",
    runtimeId: "crawclaw-sbx-test",
    runtimeLabel: "crawclaw-sbx-test",
    containerName: "crawclaw-sbx-test",
    ...
    browser: {
      ...
      containerName: "crawclaw-sbx-browser-test",
    },
...
describe("buildEmbeddedSandboxInfo", () => {
  ...
  it("maps sandbox context into prompt info", () => {
    ...
    expect(buildEmbeddedSandboxInfo(sandbox)).toEqual({
      ...
      browserPinchTabUrl: "http://localhost:9867",
