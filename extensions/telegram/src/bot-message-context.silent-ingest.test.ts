...
vi.mock("crawclaw/plugin-sdk/hook-runtime", async (importOriginal) => {
  const actual = await importOriginal<typeof import("crawclaw/plugin-sdk/hook-runtime")>();
  return {
    ...actual,
