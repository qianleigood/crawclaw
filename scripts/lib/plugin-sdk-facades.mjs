...
export const GENERATED_PLUGIN_SDK_FACADES = [
  ...
  },
  {
    ...
    directExports: {
      ...
      DEFAULT_CRAWCLAW_BROWSER_COLOR: "./browser-config.js",
      DEFAULT_CRAWCLAW_BROWSER_PROFILE_NAME: "./browser-config.js",
...
function normalizeFacadeSourceParts(sourcePath) {
  const packageSourceMatch = /^@crawclaw\/([^/]+)\/([^/]+)$/u.exec(sourcePath);
