...
type ConfiguredWebSearchProvider = NonNullable<
  NonNullable<NonNullable<CrawClawConfig["tools"]>["web"]>["search"]
>["provider"];

export type WebSearchConfig = NonNullable<CrawClawConfig["tools"]>["web"] extends infer Web
...
export function resolveSearchConfig(cfg?: CrawClawConfig): WebSearchConfig {
