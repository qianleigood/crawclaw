---
summary: "CrawClaw tools and plugins overview: what the agent can do and how to extend it"
read_when:
  - You want to understand what tools CrawClaw provides
...
CrawClaw has three layers that work together:
