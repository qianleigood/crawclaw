...
You can point CrawClaw at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or CrawClaw
...
- [Anthropic provider](/providers/anthropic) - Native CrawClaw integration with Claude setup-token or API keys
