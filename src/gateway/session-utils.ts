...
function listConfiguredAgentIds(cfg: CrawClawConfig): string[] {
...
export function listAgentsForGateway(cfg: CrawClawConfig): {
  defaultId: string;
  mainKey: string;
  scope: SessionScope;
...
function resolveDefaultStoreAgentId(cfg: CrawClawConfig): string {
...
function resolveSessionStoreAgentId(cfg: CrawClawConfig, canonicalKey: string): string {
...
export function loadCombinedSessionStoreForGateway(cfg: CrawClawConfig): {
  storePath: string;
  store: Record<string, SessionEntry>;
} {
  const storeConfig = cfg.session?.store;
...
export function getSessionDefaults(cfg: CrawClawConfig): GatewaySessionsDefaults {
