import { resolveActiveTalkProviderConfig } from "crawclaw/plugin-sdk/config-runtime";
import type { SpeechVoiceOption } from "crawclaw/plugin-sdk/speech";
import { definePluginEntry, type CrawClawPluginApi } from "./api.js";
