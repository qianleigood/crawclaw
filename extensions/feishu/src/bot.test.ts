import type * as ConversationRuntime from "crawclaw/plugin-sdk/conversation-runtime";
import type { ResolvedAgentRoute } from "crawclaw/plugin-sdk/routing";
import { beforeEach, describe, expect, it, vi } from "vitest";
import { createPluginRuntimeMock } from "../../../test/helpers/plugins/plugin-runtime-mock.js";
import { createRuntimeEnv } from "../../../test/helpers/plugins/runtime-env.js";
import type { CrawClawConfig, PluginRuntime, RuntimeEnv } from "../runtime-api.js";
...
async function dispatchMessage(params: { cfg: CrawClawConfig; event: FeishuMessageEvent }) {
...
describe("handleFeishuMessage command authorization", () => {
  ...
  it("maps groupSessionScope=group_topic to topic routing", async () => {
    mockShouldComputeCommandAuthorized.mockReturnValue(false);
  ...
  it("uses root_id for groupSessionScope=group_topic when both root_id and thread_id exist", async () => {
    mockShouldComputeCommandAuthorized.mockReturnValue(false);
