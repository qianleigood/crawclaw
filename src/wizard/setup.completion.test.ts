...
describe("setupWizardShellCompletion", () => {
  it("QuickStart: installs without prompting", async () => {
    ...
    expect(deps.ensureCompletionCacheExists).toHaveBeenCalledWith("crawclaw");
    expect(deps.installCompletion).toHaveBeenCalledWith("zsh", true, "crawclaw");
