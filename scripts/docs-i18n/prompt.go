...
- Keep product names in English: CrawClaw, Pi, Weixin, Feishu, community chat, Weixin, Feishu, Microsoft Teams, native chat, native channel.
- For the CrawClaw Gateway, use “Gateway 网关”.
