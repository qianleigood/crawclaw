...
export const DEFAULT_SANDBOX_IMAGE = "crawclaw-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "crawclaw-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_PREFIX = "crawclaw-sbx-browser-";
export const DEFAULT_SANDBOX_BROWSER_NETWORK = "crawclaw-sandbox-browser";
export const DEFAULT_SANDBOX_BROWSER_CDP_PORT = 9222;
export const DEFAULT_SANDBOX_BROWSER_PINCHTAB_PORT = 9867;
