...
fn conversation_context_summary(summary: AgentRuntimeContextSummary) -> ConversationContextSummary {
    ConversationContextSummary {
        ...
        model_context_window: summary.budget.model_context_window,
        resolved_context_window: summary.budget.resolved_context_window,
        effective_prompt_budget: summary.budget.max_prompt_tokens,
        output_reserve_tokens: summary.budget.output_reserve_tokens,
        provider_overhead_tokens: summary.budget.provider_overhead_tokens,
        tool_schema_tokens: summary.budget.tool_schema_tokens,
        budget_source: summary.budget.budget_source,
        supports_tools: summary.budget.supports_tools,
        supports_reasoning: summary.budget.supports_reasoning,
        supports_image_input: summary.budget.supports_image_input,
        supports_streaming: summary.budget.supports_streaming,
