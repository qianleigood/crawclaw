...
export function collectConfiguredModelPricingRefs(config: CrawClawConfig): ModelRef[] {
...
function scheduleRefresh(params: { config: CrawClawConfig; fetchImpl: typeof fetch }): void {
  clearRefreshTimer();
