...
describe("iconForTab", () => {
  ...
  it("returns stable icons for known tabs", () => {
    ...
    expect(iconForTab("workflows")).toBe("wrench");
...
describe("normalizeBasePath", () => {
  ...
  it("handles nested paths", () => {
    expect(normalizeBasePath("/apps/crawclaw")).toBe("/apps/crawclaw");
  });
});
...
describe("pathForTab", () => {
  ...
  it("prepends base path", () => {
    ...
    expect(pathForTab("sessions", "/apps/crawclaw")).toBe("/apps/crawclaw/sessions");
  });
});
...
describe("tabFromPath", () => {
  ...
  it("handles base paths", () => {
    ...
    expect(tabFromPath("/apps/crawclaw/sessions", "/apps/crawclaw")).toBe("sessions");
  });
...
describe("inferBasePathFromPathname", () => {
  ...
  it("infers base path from nested paths", () => {
    ...
    expect(inferBasePathFromPathname("/apps/crawclaw/sessions")).toBe("/apps/crawclaw");
  });
