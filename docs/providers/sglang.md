---
summary: "Run CrawClaw with SGLang (OpenAI-compatible self-hosted server)"
read_when:
  - You want to run CrawClaw against a local SGLang server
...
CrawClaw can connect to SGLang using the `openai-completions` API.

CrawClaw can also **auto-discover** available models from SGLang when you opt
