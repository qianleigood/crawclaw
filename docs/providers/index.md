---
summary: "Model providers (LLMs) supported by CrawClaw"
read_when:
...
CrawClaw can use many LLM providers. Pick a provider, authenticate, then set the
default model as `provider/model`.

Looking for chat channel docs (Weixin/Feishu/community chat/Feishu/native channels (plugin)/etc.)? See [Channels](/channels).
