...
function resolveAcpStreamCoalesceIdleMs(cfg: CrawClawConfig): number {
...
function resolveAcpStreamMaxChunkChars(cfg: CrawClawConfig): number {
...
export function resolveAcpProjectionSettings(cfg: CrawClawConfig): AcpProjectionSettings {
