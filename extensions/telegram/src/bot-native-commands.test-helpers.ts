...
import type { ChannelGroupPolicy } from "crawclaw/plugin-sdk/config-runtime";
import type { TelegramAccountConfig } from "crawclaw/plugin-sdk/config-runtime";
...
type GetPluginCommandSpecsFn =
  typeof import("crawclaw/plugin-sdk/plugin-runtime").getPluginCommandSpecs;
type MatchPluginCommandFn = typeof import("crawclaw/plugin-sdk/plugin-runtime").matchPluginCommand;
type ExecutePluginCommandFn =
  typeof import("crawclaw/plugin-sdk/plugin-runtime").executePluginCommand;
type DispatchReplyWithBufferedBlockDispatcherFn =
  typeof import("crawclaw/plugin-sdk/reply-dispatch-runtime").dispatchReplyWithBufferedBlockDispatcher;
...
vi.mock("crawclaw/plugin-sdk/plugin-runtime", () => ({
...
vi.mock("crawclaw/plugin-sdk/reply-dispatch-runtime", async (importOriginal) => {
  const actual =
    await importOriginal<typeof import("crawclaw/plugin-sdk/reply-dispatch-runtime")>();
  return {
    ...actual,
...
vi.mock("crawclaw/plugin-sdk/channel-reply-pipeline", async (importOriginal) => {
  const actual =
    await importOriginal<typeof import("crawclaw/plugin-sdk/channel-reply-pipeline")>();
  return {
    ...actual,
...
export function createNativeCommandsHarness(params?: {
  ...
  const telegramDeps = {
    loadConfig: vi.fn(() => params?.cfg ?? ({} as CrawClawConfig)),
