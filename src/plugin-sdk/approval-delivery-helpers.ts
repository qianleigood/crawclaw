...
import type { CrawClawConfig } from "./config-runtime.js";
...
type ApproverRestrictedNativeApprovalParams = {
  ...
  isNativeDeliveryEnabled: (params: { cfg: CrawClawConfig; accountId?: string | null }) => boolean;
...
function buildApproverRestrictedNativeApprovalCapability(
  ...
  return createChannelApprovalCapability({
    ...
    approvals: {
      delivery: {
        hasConfiguredDmRoute: ({ cfg }: { cfg: CrawClawConfig }) =>
