...
- 已去掉 `write_knowledge_note` 对 durable extraction 的抑制
...
- NotebookLM knowledge 写入和 durable collaboration memory 不是同一层
- 一轮里既写 knowledge，又值得补 durable feedback/project，是完全合理的
