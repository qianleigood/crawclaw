...
function resolveSpeechProviderPluginEntries(cfg?: CrawClawConfig): SpeechProviderPlugin[] {
...
function buildProviderMaps(cfg?: CrawClawConfig): {
...
export function listSpeechProviders(cfg?: CrawClawConfig): SpeechProviderPlugin[] {
