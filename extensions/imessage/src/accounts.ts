...
function mergeIMessageAccountConfig(cfg: CrawClawConfig, accountId: string): IMessageAccountConfig {
...
export function listEnabledIMessageAccounts(cfg: CrawClawConfig): ResolvedIMessageAccount[] {
