...
function createCommand(cfg: CrawClawConfig, discordConfig?: DiscordAccountConfig) {
...
function createDispatchSpy() {
  ...
  nativeCommandTesting.setDispatchReplyWithDispatcher(
    dispatcherModule.dispatchReplyWithDispatcher as typeof import("crawclaw/plugin-sdk/reply-runtime").dispatchReplyWithDispatcher,
  );
  return dispatchSpy;
}
...
async function runGuildSlashCommand(params?: {
  userId?: string;
  mutateConfig?: (cfg: CrawClawConfig) => void;
