...
import { WEBHOOK_IN_FLIGHT_DEFAULTS } from "crawclaw/plugin-sdk/webhook-request-guards";
...
vi.mock("crawclaw/plugin-sdk/reply-runtime", () => ({
...
vi.mock("crawclaw/plugin-sdk/channel-reply-pipeline", () => ({
  createChannelReplyPipeline: vi.fn(() => ({})),
}));

vi.mock("crawclaw/plugin-sdk/webhook-ingress", () => ({
