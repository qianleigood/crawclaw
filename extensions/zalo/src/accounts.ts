...
function mergeZaloAccountConfig(cfg: CrawClawConfig, accountId: string): ZaloAccountConfig {
...
export function listEnabledZaloAccounts(cfg: CrawClawConfig): ResolvedZaloAccount[] {
