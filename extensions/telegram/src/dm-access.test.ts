import type { createChannelPairingChallengeIssuer } from "crawclaw/plugin-sdk/channel-pairing";
...
vi.mock("crawclaw/plugin-sdk/channel-pairing", () => ({
...
vi.mock("crawclaw/plugin-sdk/conversation-runtime", () => ({
