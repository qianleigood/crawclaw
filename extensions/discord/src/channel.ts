...
} from "crawclaw/plugin-sdk/allowlist-config-edit";
...
import { createOpenProviderConfiguredRouteWarningCollector } from "crawclaw/plugin-sdk/channel-policy";
import { resolveTargetsWithOptionalToken } from "crawclaw/plugin-sdk/channel-targets";
...
import { normalizeMessageChannel } from "crawclaw/plugin-sdk/routing";
import {
    ...
    base: {
      ...
      agentPrompt: {
        messageToolHints: () => [
          ...
          "- Forms: add `components.modal` (title, fields). CrawClaw adds a trigger button and routes submissions as new messages.",
        ],
      },
      messaging: {
